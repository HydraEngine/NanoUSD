...
#define USD_SKEL_VALIDATION_ERROR_NAME_TOKENS \
    ((missingSkelBindingAPI, "MissingSkelBindingAPI"))((invalidSkelBindingAPIApply, "InvalidSkelBindingAPIApply"))

/// \def USD_SKEL_VALIDATOR_NAME_TOKENS
/// Tokens representing validator names. Note that for plugin provided
/// validators, the names must be prefixed by usdSkel:, which is the name of
/// the usdSkel plugin.
TF_DECLARE_PUBLIC_TOKENS(UsdSkelValidatorNameTokens, USDSKEL_API, USD_SKEL_VALIDATOR_NAME_TOKENS);
...
/// validator.
TF_DECLARE_PUBLIC_TOKENS(UsdSkelValidatorKeywordTokens, USDSKEL_API, USD_SKEL_VALIDATOR_KEYWORD_TOKENS);
/// \def USD_SKEL_VALIDATION_ERROR_NAME_TOKENS
/// Tokens representing validation error identifier.
TF_DECLARE_PUBLIC_TOKENS(UsdSkelValidationErrorNameTokens, USDSKEL_API, USD_SKEL_VALIDATION_ERROR_NAME_TOKENS);

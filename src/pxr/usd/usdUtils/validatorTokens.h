...
#define USD_UTILS_VALIDATION_ERROR_NAME_TOKENS \
    ((layerNotInPackage, "LayerNotInPackage"))((assetNotInPackage, "AssetNotInPackage"))

///\def
/// Tokens representing validator names. Note that for plugin provided
/// validators, the names must be prefixed by usdGeom:, which is the name of
/// the usdGeom plugin.
TF_DECLARE_PUBLIC_TOKENS(UsdUtilsValidatorNameTokens, USDUTILS_API, USD_UTILS_VALIDATOR_NAME_TOKENS);
...
/// validator.
TF_DECLARE_PUBLIC_TOKENS(UsdUtilsValidatorKeywordTokens, USDUTILS_API, USD_UTILS_VALIDATOR_KEYWORD_TOKENS);

/// \def USD_UTILS_VALIDATION_ERROR_NAME_TOKENS
/// Tokens representing validation error identifier.
TF_DECLARE_PUBLIC_TOKENS(UsdUtilsValidationErrorNameTokens, USDUTILS_API, USD_UTILS_VALIDATION_ERROR_NAME_TOKENS);

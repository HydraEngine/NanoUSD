...
void UsdUtilsCoalescingDiagnosticDelegate::IssueError(const TfError& err) {
...
void UsdUtilsCoalescingDiagnosticDelegate::IssueStatus(const TfStatus& status) {
    _diagnostics.push(new TfStatus(status));
}

void UsdUtilsCoalescingDiagnosticDelegate::IssueWarning(const TfWarning& warning) {
...
UsdUtilsCoalescingDiagnosticDelegateVector UsdUtilsCoalescingDiagnosticDelegate::TakeCoalescedDiagnostics() {
    std::unordered_map<UsdUtilsCoalescingDiagnosticDelegateSharedItem, size_t, _CoalescedItemHash,
...
std::vector<std::unique_ptr<TfDiagnosticBase>> UsdUtilsCoalescingDiagnosticDelegate::TakeUncoalescedDiagnostics() {

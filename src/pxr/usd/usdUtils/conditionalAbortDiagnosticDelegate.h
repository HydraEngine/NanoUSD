...
public:
    ...
    const std::vector<std::string>& GetStringFilters() const { return _stringFilters; };

    const std::vector<std::string>& GetCodePathFilters() const { return _codePathFilters; }
...
public:
    ...
    UsdUtilsConditionalAbortDiagnosticDelegate& operator=(const UsdUtilsConditionalAbortDiagnosticDelegate& delegate) =
            delete;

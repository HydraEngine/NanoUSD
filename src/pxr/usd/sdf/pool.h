...
public:
    ...
    struct Handle {
        ...
        static inline Handle GetHandle(char const* ptr) noexcept { return Sdf_Pool::_GetHandle(ptr); }
        explicit operator bool() const { return value != 0; }
        inline bool operator==(Handle const& r) const noexcept { return value == r.value; }
        inline bool operator!=(Handle const& r) const noexcept { return value != r.value; }
        inline bool operator<(Handle const& r) const noexcept { return value < r.value; }
...
private:
    ...
    struct _RegionState {
        ...
        static constexpr _RegionState GetLockedState() { return _RegionState(LockedState, LockedState); }

        constexpr bool operator==(_RegionState other) const { return _state == other._state; }
...
private:
    ...
    static bool _TakeSharedFreeList(_FreeList& out) { return _sharedFreeLists->try_pop(out); }

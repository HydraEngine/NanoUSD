...
#define SDF_TOKENS ((AnyTypeToken, "__AnyType__"))
...
#define SDF_PATH_TOKENS                                                                                            \
    ((absoluteIndicator, SDF_PATH_ABSOLUTE_INDICATOR_STR))((relativeRoot, SDF_PATH_RELATIVE_ROOT_STR))(            \
            (childDelimiter, SDF_PATH_CHILD_DELIMITER_STR))((propertyDelimiter, SDF_PATH_PROPERTY_DELIMITER_STR))( \
            (relationshipTargetStart, SDF_PATH_RELATIONSHIP_TARGET_START_STR))(                                    \
            (relationshipTargetEnd, SDF_PATH_RELATIONSHIP_TARGET_END_STR))((parentPathElement, ".."))(             \
...
#define SDF_METADATA_DISPLAYGROUP_TOKENS                                                                            \
    ((core, ""))((internal, "Internal"))((dmanip, "Direct Manip"))((pipeline, "Pipeline"))((symmetry, "Symmetry"))( \
            (ui, "User Interface"))

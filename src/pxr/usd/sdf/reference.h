...
public:
    ...
    ///
    void SetLayerOffset(const SdfLayerOffset& layerOffset) { _layerOffset = layerOffset; }
    ...
    ///
    void SetCustomData(const VtDictionary& customData) { _customData = customData; }
    ...
    void SwapCustomData(VtDictionary& customData) { _customData.swap(customData); }

...
public:
    ...
    /// couldn't be created.
    static bool CreateSpec(const SdfLayerHandle& layer,
    ...
    SDF_API
    static bool Rename(const SdfSpec& spec, const FieldType& newName);
    ...
    SDF_API
    static bool RemoveChild(const SdfLayerHandle& layer, const SdfPath& path, const typename ChildPolicy::KeyType& key);
    ...
    SDF_API
    static bool MoveChildForBatchNamespaceEdit(const SdfLayerHandle& layer,
                                               const SdfPath& path,
                                               const typename ChildPolicy::ValueType& value,
    ...
    /// Remove the child identified by \a key.
    SDF_API
    static bool RemoveChildForBatchNamespaceEdit(const SdfLayerHandle& layer,
                                                 const SdfPath& path,
    ...
    SDF_API
    static bool CanMoveChildForBatchNamespaceEdit(const SdfLayerHandle& layer,
                                                  const SdfPath& path,
                                                  const typename ChildPolicy::ValueType& value,
                                                  const typename ChildPolicy::FieldType& newName,
                                                  int index,
    ...
    SDF_API
    static bool CanRemoveChildForBatchNamespaceEdit(const SdfLayerHandle& layer,
                                                    const SdfPath& path,

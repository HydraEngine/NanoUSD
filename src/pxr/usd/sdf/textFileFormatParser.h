...
struct Keywords : PEGTL_NS::sor<KeywordAdd,
                                KeywordAppend,
                                KeywordBezier,
                                KeywordClass,
                                KeywordConfig,
...
struct PythonStyleComment : PEGTL_NS::disable<PEGTL_NS::one<'#'>, SingleLineContents> {};
struct CppStyleSingleLineComment : PEGTL_NS::disable<PEGTL_NS::two<'/'>, SingleLineContents> {};
struct CppStyleMultiLineComment
    : PEGTL_NS::disable<CppStyleMultilineOpen, PEGTL_NS::until<CppStyleMultilineClose, Utf8>> {};
struct Comment : PEGTL_NS::sor<PythonStyleComment, CppStyleSingleLineComment, CppStyleMultiLineComment> {};
...
struct InlinePadding : PEGTL_NS::sor<Space, CppStyleMultiLineComment> {};
struct SinglelinePadding : PEGTL_NS::sor<Space, Comment> {};
struct MultilinePadding : PEGTL_NS::sor<Space, Eol, Comment> {};
struct TokenSeparator : PEGTL_NS::pad<Space, CppStyleMultiLineComment, InlinePadding> {};

// array type
struct ArrayType : PEGTL_NS::if_must<LeftBracket, PEGTL_NS::star<InlinePadding>, RightBracket> {};
...
struct StatementSeparator : PEGTL_NS::sor<Eol, PEGTL_NS::one<';'>> {};
...
// generic lists
template <typename R>
struct ListOf : PEGTL_NS::list_tail<R, PEGTL_NS::pad<ListSeparator, InlinePadding, MultilinePadding>> {};

// generic statements
template <typename R>
struct StatementSequenceOf
    : PEGTL_NS::list_tail<R, PEGTL_NS::pad<StatementSeparator, SinglelinePadding, MultilinePadding>> {};
...
//		    -inf /
// 		    nan
struct ExponentPart : PEGTL_NS::opt_must<Exponent, PEGTL_NS::opt<Sign>, PEGTL_NS::plus<Digit>> {};
struct NumberStandard
    : PEGTL_NS::seq<PEGTL_NS::plus<Digit>, PEGTL_NS::opt<Sdf_PathParser::Dot, PEGTL_NS::star<Digit>>, ExponentPart> {};
struct NumberLeadingDot : PEGTL_NS::seq<PEGTL_NS::if_must<Sdf_PathParser::Dot, PEGTL_NS::plus<Digit>>, ExponentPart> {};
struct Number
    : PEGTL_NS::sor<
              PEGTL_NS::seq<PEGTL_NS::opt<Minus>, PEGTL_NS::sor<NumberStandard, NumberLeadingDot, MathKeywordInf>>,
              MathKeywordNan> {};
...
struct MultilineString
    : PEGTL_NS::if_must<
              ...
              PEGTL_NS::until<PEGTL_NS::three<QuoteCharacter>,
                              PEGTL_NS::sor<PEGTL_NS::two<'\\'>, PEGTL_NS::string<'\\', QuoteCharacter>, Utf8>>> {};
template <char QuoteCharacter>
struct SinglelineString
    : PEGTL_NS::if_must<
              PEGTL_NS::one<QuoteCharacter>,
              PEGTL_NS::until<PEGTL_NS::one<QuoteCharacter>,
                              PEGTL_NS::sor<PEGTL_NS::two<'\\'>, PEGTL_NS::string<'\\', QuoteCharacter>, Utf8NoEolf>>> {
};
...
struct String : PEGTL_NS::sor<MultilineSingleQuoteString,
                              SinglelineSingleQuoteString,
                              MultilineDoubleQuoteString,
                              SinglelineDoubleQuoteString> {};

struct EscapeAtAtAt : PEGTL_NS::seq<PEGTL_NS::one<'\\'>, AtAtAt> {};
...
struct AssetRef : PEGTL_NS::sor<PEGTL_NS::if_must<AtAtAt,
                                                  // A triple quoted asset path is closed by 3-5 @, with the last three
                                                  // always "closing" and the previous 0-2 being considered a part of
                                                  // the asset path.
                                                  PEGTL_NS::until<PEGTL_NS::seq<AtAtAt, PEGTL_NS::rep_opt<2, At>>,
                                                                  PEGTL_NS::sor<EscapeAtAtAt, Utf8NoEolf>>>,
                                PEGTL_NS::if_must<At, PEGTL_NS::until<At, Utf8NoEolf>>> {};

// path reference
// PathRef = <> /
//           < Path >
struct PathRef
    : PEGTL_NS::if_must<LeftAngleBracket,
                        PEGTL_NS::sor<RightAngleBracket, PEGTL_NS::seq<Sdf_PathParser::Path, RightAngleBracket>>> {};

// LayerOffset = offset Assignment Number /
//	             scale Assignment Number
struct LayerOffset : PEGTL_NS::seq<PEGTL_NS::sor<KeywordOffset, KeywordScale>, Assignment, Number> {};

// grammar rule that matches UTF-8 identifiers
struct BaseIdentifier : Sdf_PathParser::Utf8Identifier {};
struct KeywordlessIdentifier : PEGTL_NS::minus<Sdf_PathParser::Utf8Identifier, Keywords> {};
struct NamespacedIdentifier : PEGTL_NS::list<BaseIdentifier, NamespaceSeparator> {};
...
struct Identifier : PEGTL_NS::list<KeywordlessIdentifier, CXXNamespaceSeparator> {};
...
struct AtomicValue : PEGTL_NS::sor<NumberValue, IdentifierValue, StringValue, AssetRefValue> {};
...
//              ListValue /
//              PathRefValue
struct TypedValue : PEGTL_NS::sor<AtomicValue, TypedTupleValue, EmptyListValue, TypedListValue, PathRefValue> {};
...
struct TupleValueItem : PEGTL_NS::sor<NumberValue, IdentifierValue, StringValue, AssetRefValue, TupleValue> {};

struct TupleValue
    : PEGTL_NS::if_must<TupleValueOpen, PEGTL_NS::pad<ListOf<TupleValueItem>, MultilinePadding>, TupleValueClose> {};
...
struct ListValueItem : PEGTL_NS::sor<NumberValue, IdentifierValue, StringValue, AssetRefValue, ListValue, TupleValue> {
};
struct ListValue
    : PEGTL_NS::if_must<ListValueOpen, PEGTL_NS::pad<ListOf<ListValueItem>, MultilinePadding>, ListValueClose> {};
...
struct EmptyListValue : PEGTL_NS::seq<LeftBracket, PEGTL_NS::star<InlinePadding>, RightBracket> {};
...
struct DictionaryKey : PEGTL_NS::sor<String, BaseIdentifier> {};
struct DictionaryType : PEGTL_NS::seq<Identifier, PEGTL_NS::opt<PEGTL_NS::star<InlinePadding>, ArrayType>> {};
struct DictionaryValueItem
    : PEGTL_NS::sor<PEGTL_NS::if_must<KeywordDictionary, TokenSeparator, DictionaryKey, Assignment, DictionaryValue>,
                    PEGTL_NS::seq<DictionaryType, TokenSeparator, DictionaryKey, Assignment, TypedValue>> {};
struct DictionaryValue
    : PEGTL_NS::if_must<DictionaryValueOpen,
                        PEGTL_NS::pad_opt<StatementSequenceOf<DictionaryValueItem>, MultilinePadding>,
...
struct MetadataBlock : PEGTL_NS::if_must<MetadataOpen,
                                         PEGTL_NS::pad_opt<StatementSequenceOf<ItemType>, MultilinePadding>,
                                         MetadataClose> {};
...
struct MetadataKey : PEGTL_NS::sor<KeywordCustomData, KeywordSymmetryArguments, Identifier> {};
struct KeyValueMetadata
    : PEGTL_NS::seq<MetadataKey, Assignment, PEGTL_NS::sor<KeywordNone, DictionaryValue, TypedValue>> {};
struct LayerKeyValueMetadata
    : PEGTL_NS::seq<Identifier, Assignment, PEGTL_NS::sor<KeywordNone, DictionaryValue, TypedValue>> {};

// DocMetadata = doc Assignment String
struct DocMetadata : PEGTL_NS::seq<KeywordDoc, Assignment, String> {};

struct ListOpKeyword : PEGTL_NS::sor<KeywordAdd, KeywordDelete, KeywordAppend, KeywordPrepend, KeywordReorder> {};

struct NoneOrTypedListValue : PEGTL_NS::sor<KeywordNone, TypedListValue> {};
struct ListOpKeyValueMetadata : PEGTL_NS::seq<Identifier, Assignment, PEGTL_NS::must<NoneOrTypedListValue>> {};
...
struct GeneralListOpMetadata
    : PEGTL_NS::seq<ListOpKeyword, TokenSeparator, Identifier, Assignment, PEGTL_NS::sor<KeywordNone, TypedListValue>> {
};
...
struct SharedMetadata : PEGTL_NS::sor<String, KeyValueMetadata, DocMetadata> {};
struct SharedWithListOpMetadata : PEGTL_NS::sor<SharedMetadata, GeneralListOpMetadata> {};
struct LayerSharedWithListOpMetadata
    : PEGTL_NS::sor<String, LayerKeyValueMetadata, DocMetadata, GeneralListOpMetadata> {};

// PermissionMetadata = permission Assignment Identifier
struct PermissionMetadata : PEGTL_NS::if_must<KeywordPermission, Assignment, Identifier> {};

// SymmetryFunctionMetadata = symmetryFunction Assignment (Identifier)?
struct SymmetryFunctionMetadata : PEGTL_NS::seq<KeywordSymmetryFunction, Assignment, PEGTL_NS::opt<Identifier>> {};

// NameList = String /
//            [ (NewLines)? (TokenSeparator)? String (TokenSeparator)?
//            (ListSeparator (TokenSeparator)? String (TokenSeparator)?)*
//            ListEnd (TokenSeparator)? ]
struct NameList : PEGTL_NS::sor<String,
                                PEGTL_NS::if_must<LeftBracket,
                                                  // Should this be optional?
                                                  PEGTL_NS::pad<ListOf<String>, MultilinePadding>,
                                                  RightBracket>> {};

// StringDictionaryItem = String (TokenSeparator)? : (TokenSeparator)? String
struct StringDictionaryItem : PEGTL_NS::seq<String, PEGTL_NS::pad<NamespaceSeparator, InlinePadding>, String> {};
...
struct StringDictionary : PEGTL_NS::must<StringDictionaryOpen,
...
struct TimeSample
    : PEGTL_NS::seq<Number, PEGTL_NS::pad<NamespaceSeparator, InlinePadding>, PEGTL_NS::sor<KeywordNone, TypedValue>> {
};

// TimeSampleMap = { (NewLines)? ((TokenSeparator)? TimeSample
// (TokenSeparator)? (ListSeparator (TokenSeparator)? TimeSample
// (TokenSeparator)?)* ListEnd)? (TokenSeparator)? }
struct TimeSampleMap : PEGTL_NS::seq<LeftBrace, PEGTL_NS::pad_opt<ListOf<TimeSample>, MultilinePadding>, RightBrace> {};

// splines

// SplineCurveTypeItem = BEZIER / HERMITE
struct SplineCurveTypeItem : PEGTL_NS::sor<KeywordHermite, KeywordBezier> {};
...
struct SplineExtrapolationType : PEGTL_NS::sor<KeywordNone_LC,
                                               KeywordHeld,
                                               KeywordLinear,
...
// SplineExtrapolation
struct SplinePreExtrapItem : PEGTL_NS::seq<KeywordPre, PEGTL_NS::pad<Colon, InlinePadding>, SplineExtrapolationType> {};

// SplinePostExtrapItem = post (TokenSeparator)? Colon (TokenSeparator)?
// SplineExtrapolation
struct SplinePostExtrapItem : PEGTL_NS::seq<KeywordPost, PEGTL_NS::pad<Colon, InlinePadding>, SplineExtrapolationType> {
};
...
// )
struct SplineLoopItem : PEGTL_NS::seq<KeywordLoop,
...
struct SplineTangentWithWidthValue
    : PEGTL_NS::seq<SplineTangentWidth, PEGTL_NS::pad<ListSeparator, InlinePadding>, SplineTangentValue> {};
// SplineTangentWithoutWidthValue = Number (TokenSeparator)?
// (not at SplineKnotPreValueSeparator)
struct SplineTangentWithoutWidthValue
    : PEGTL_NS::seq<PEGTL_NS::pad<SplineTangentValue, InlinePadding>, PEGTL_NS::not_at<ListSeparator>> {};
...
//                   (TokenSeparator)? )
struct SplineTangent : PEGTL_NS::sor<PEGTL_NS::seq<PEGTL_NS::pad<LeftParen, InlinePadding>,
...
struct SplineInterpMode : PEGTL_NS::sor<KeywordNone_LC, KeywordHeld, KeywordLinear, KeywordCurve> {};

// SplinePreTan = pre TokenSeparator SplineTangent
struct SplinePreTan : PEGTL_NS::seq<KeywordPre, TokenSeparator, SplineTangent> {};

// SplinePostShaping = post (TokenSeparator)? SplineInterpMode (TokenSeparator)?
// (SplineTangent)?
struct SplinePostShaping
    : PEGTL_NS::seq<KeywordPost, PEGTL_NS::pad<SplineInterpMode, InlinePadding>, PEGTL_NS::opt<SplineTangent>> {};

// SplineKnotParam = SplinePreTan / SplinePostShaping / DictionaryValue
struct SplineKnotParam : PEGTL_NS::sor<SplinePreTan, SplinePostShaping, DictionaryValue> {};
...
struct SplineKnotParamList
    : PEGTL_NS::opt<PEGTL_NS::if_must<SplineKnotParamSeparator,
                                      PEGTL_NS::seq<PEGTL_NS::pad<StatementSequenceOf<SplineKnotParam>, InlinePadding>,
...
struct SplineKnotValueWithoutPreValue
    : PEGTL_NS::seq<SplineKnotValue, PEGTL_NS::pad<PEGTL_NS::not_at<SplineKnotPreValueSeparator>, InlinePadding>> {};
...
struct SplineKnotValueWithPreValue
    : PEGTL_NS::seq<SplineKnotPreValue, PEGTL_NS::pad<SplineKnotPreValueSeparator, InlinePadding>, SplineKnotValue> {};

// SplineKnotValues = SplineKnotValueWithoutPreValue /
// SplineKnotValueWithPreValue
struct SplineKnotValues : PEGTL_NS::sor<SplineKnotValueWithoutPreValue, SplineKnotValueWithPreValue> {};

struct SplineKnotTime : Number {};
// SplineKnotItem = Number (TokenSeparator)? : (TokenSeparator)?
// SplineKnotValues (SplineKnotParamList)?
struct SplineKnotItem
    : PEGTL_NS::seq<SplineKnotTime, PEGTL_NS::pad<Colon, InlinePadding>, SplineKnotValues, SplineKnotParamList> {};

// SplineItem = SplineCurveTypeItem / SplinePreExtrapItem /
// SplinePostExtrapItem / SplineLoopItem / SplineKnotItem
struct SplineItem
    : PEGTL_NS::sor<SplineCurveTypeItem, SplinePreExtrapItem, SplinePostExtrapItem, SplineLoopItem, SplineKnotItem> {};

// SplineValue = { (TokenSeparator)? (SplineItem (TokenSeparator)?)* }
struct SplineValue : PEGTL_NS::if_must<LeftBrace, PEGTL_NS::pad<ListOf<SplineItem>, MultilinePadding>, RightBrace> {};

// prim attribute metadata
// DisplayUnitMetadata = displayUnit Assignment Identifier
struct DisplayUnitMetadata : PEGTL_NS::if_must<KeywordDisplayUnit, Assignment, Identifier> {};

// AttributeMetadataItem = SharedWithListOpMetadata /
//                         DisplayUnitMetadata /
//                         PermissionMetadata /
//                         SymmetryFunctionMetadata
struct AttributeMetadataItem
    : PEGTL_NS::sor<SharedWithListOpMetadata, DisplayUnitMetadata, PermissionMetadata, SymmetryFunctionMetadata> {};
...
struct AttributeVariability : PEGTL_NS::sor<KeywordConfig, KeywordUniform> {};

// AttributeType = (AttributeVariability TokenSeparator)? Identifier
// (TokenSeparator)? ([ (TokenSeparator)? ])?
struct AttributeType : PEGTL_NS::seq<PEGTL_NS::opt<AttributeVariability, TokenSeparator>,
                                     Identifier,
                                     PEGTL_NS::opt<PEGTL_NS::star<InlinePadding>, ArrayType>> {};

// AttributeDeclaration = AttributeType TokenSeparator NamespacedName
struct AttributeDeclaration
    : PEGTL_NS::seq<PEGTL_NS::opt<KeywordCustom, TokenSeparator>, AttributeType, TokenSeparator, NamespacedName> {};

// AttributeValue = None / TypedValue
// AttributeAssignment = Assignment AttributeValue
struct AttributeAssignment : PEGTL_NS::seq<Assignment, PEGTL_NS::sor<KeywordNone, TypedValue>> {};
struct AttributeAssignmentOptional : PEGTL_NS::opt<AttributeAssignment> {};
...
struct ConnectValue
    : PEGTL_NS::sor<
              KeywordNone,
              PathRef,
              PEGTL_NS::if_must<LeftBracket, PEGTL_NS::pad_opt<ListOf<PathRef>, MultilinePadding>, RightBracket>> {};
...
struct AttributeSpec
    : PEGTL_NS::seq<
              ...
              PEGTL_NS::if_must_else<
                      ...
                      PEGTL_NS::sor<PEGTL_NS::if_must<KeywordTimeSamples, PEGTL_NS::seq<Assignment, TimeSampleMap>>,
                                    PEGTL_NS::if_must<KeywordConnect, PEGTL_NS::seq<Assignment, ConnectValue>>,
                                    PEGTL_NS::if_must<KeywordSpline, PEGTL_NS::seq<Assignment, SplineValue>>>,
                      PEGTL_NS::seq<AttributeAssignmentOptional,
...
// 				             PermissionMetadata /
// 				             SymmetryFunctionMetadata
struct RelationshipMetadataItem
    : PEGTL_NS::sor<SharedWithListOpMetadata, PermissionMetadata, SymmetryFunctionMetadata> {};
...
struct RelationshipAssignment
    : PEGTL_NS::seq<Assignment,
                    PEGTL_NS::sor<KeywordNone,
                                  PathRef,
                                  PEGTL_NS::if_must<RelationshipAssignmentOpen,
...
struct RelationshipType
    : PEGTL_NS::sor<
              KeywordRel,
              PEGTL_NS::seq<KeywordVarying, TokenSeparator, KeywordRel>,
              PEGTL_NS::seq<KeywordCustom,
                            TokenSeparator,
                            PEGTL_NS::sor<KeywordRel, PEGTL_NS::seq<KeywordVarying, TokenSeparator, KeywordRel>>>> {};
...
struct RelationshipAssignmentOptional : PEGTL_NS::opt<RelationshipAssignment> {};
struct RelationshipSpec
    : PEGTL_NS::seq<RelationshipType,
                    TokenSeparator,
                    NamespacedName,
                    PEGTL_NS::if_must_else<
                            PEGTL_NS::pad<Sdf_PathParser::Dot, InlinePadding>,
                            PEGTL_NS::sor<PEGTL_NS::if_must<KeywordDefault, PEGTL_NS::seq<Assignment, PathRef>>>,
                            PEGTL_NS::sor<PEGTL_NS::seq<PEGTL_NS::star<InlinePadding>,
                                                        PEGTL_NS::if_must<RelationshipTargetOpen,
                                                                          PEGTL_NS::pad<PathRef, InlinePadding>,
                                                                          RelationshipTargetClose>>,
                                          PEGTL_NS::seq<RelationshipAssignmentOptional,
...
struct InheritsOrSpecializesList
    : PEGTL_NS::sor<KeywordNone,
                    PathRef,
                    PEGTL_NS::seq<LeftBracket, PEGTL_NS::pad_opt<ListOf<PathRef>, MultilinePadding>, RightBracket>> {};
...
struct SpecializesMetadata : PEGTL_NS::if_must<KeywordSpecializes, Assignment, InheritsOrSpecializesList> {};
...
struct InheritsMetadata : PEGTL_NS::if_must<KeywordInherits, Assignment, InheritsOrSpecializesList> {};

// ReferenceParameter = customData Assignment DictionaryValue /
//                      LayerOffset
struct ReferenceParameter : PEGTL_NS::sor<PEGTL_NS::seq<KeywordCustomData, Assignment, DictionaryValue>, LayerOffset> {
};
...
struct ReferenceListItem
    : PEGTL_NS::seq<
              PEGTL_NS::sor<PathRef, PEGTL_NS::seq<AssetRef, PEGTL_NS::star<InlinePadding>, PEGTL_NS::opt<PathRef>>>,
              PEGTL_NS::star<InlinePadding>,
              PEGTL_NS::opt<ReferenceParametersOpen,
                            PEGTL_NS::pad_opt<StatementSequenceOf<ReferenceParameter>, MultilinePadding>,
...
//(TokenSeparator)? ]
struct ReferenceList : PEGTL_NS::sor<KeywordNone,
                                     ReferenceListItem,
                                     PEGTL_NS::seq<LeftBracket,
...
struct ReferencesMetadata : PEGTL_NS::if_must<KeywordReferences, Assignment, ReferenceList> {};
...
struct PayloadList
    : PEGTL_NS::sor<
              KeywordNone,
              PayloadListItem,
              PEGTL_NS::seq<LeftBracket, PEGTL_NS::pad_opt<ListOf<PayloadListItem>, MultilinePadding>, RightBracket>> {
};
...
struct PayloadMetadata : PEGTL_NS::if_must<KeywordPayload, Assignment, PayloadList> {};
...
struct RelocatesMetadata
    : PEGTL_NS::if_must<
              ...
              PEGTL_NS::must<
                      RelocatesMapOpen,
                      PEGTL_NS::pad_opt<
                              ListOf<PEGTL_NS::seq<PathRef, PEGTL_NS::pad<NamespaceSeparator, InlinePadding>, PathRef>>,
                              MultilinePadding>,
                      RelocatesMapClose>> {};

// VariantsMetadata = variants Assignment DictionaryValue
struct VariantsMetadata : PEGTL_NS::if_must<KeywordVariants, Assignment, DictionaryValue> {};
...
struct VariantSetsMetadata : PEGTL_NS::if_must<KeywordVariantSets, Assignment, NameList> {};

// KindMetadata = kind Assignment String
struct KindMetadata : PEGTL_NS::if_must<KeywordKind, Assignment, String> {};
...
struct PrefixOrSuffixSubstitutionsMetadata
    : PEGTL_NS::if_must<PEGTL_NS::sor<KeywordPrefixSubstitutions, KeywordSuffixSubstitutions>,
                        Assignment,
                        StringDictionary> {};
...
struct PrimMetadataItem
    : PEGTL_NS::sor<
              ...
              PEGTL_NS::if_must<
                      ...
                      PEGTL_NS::if_must_else<
                              KeywordReferences,
                              PEGTL_NS::seq<Assignment, ReferenceList>,
                              PEGTL_NS::if_must_else<
                                      KeywordPayload,
                                      PEGTL_NS::seq<Assignment, PayloadList>,
                                      PEGTL_NS::if_must_else<PEGTL_NS::sor<KeywordInherits, KeywordSpecializes>,
                                                             PEGTL_NS::seq<Assignment, InheritsOrSpecializesList>,
                                                             PEGTL_NS::if_must_else<KeywordVariantSets,
                                                                                    PEGTL_NS::seq<Assignment, NameList>,
...
struct PropertySpec
    : PEGTL_NS::sor<AttributeSpec,
                    RelationshipSpec,
                    PEGTL_NS::seq<ListOpKeyword,
                                  TokenSeparator,
                                  PEGTL_NS::if_must_else<
                                          RelationshipType,
                                          PEGTL_NS::seq<TokenSeparator, NamespacedName, RelationshipAssignmentOptional>,
                                          PEGTL_NS::seq<AttributeDeclaration,
                                                        PEGTL_NS::pad<Sdf_PathParser::Dot, InlinePadding>,
                                                        KeywordConnect,
                                                        Assignment,
                                                        ConnectValue>>>> {};
...
// NameList
struct ChildOrPropertyOrderStatement : PEGTL_NS::seq<KeywordReorder,
                                                     TokenSeparator,
                                                     PEGTL_NS::sor<KeywordNameChildren, KeywordProperties>,
                                                     Assignment,
                                                     NameList> {};
...
struct VariantStatement : PEGTL_NS::seq<String,
                                        PEGTL_NS::pad_opt<PrimMetadata, MultilinePadding>,
                                        PEGTL_NS::must<VariantStatementOpen, PrimContents, VariantStatementClose>> {};
...
struct VariantSetStatement
    : PEGTL_NS::seq<KeywordVariantSet,
                    TokenSeparator,
                    String,
                    PEGTL_NS::pad<Equals, InlinePadding, MultilinePadding>,
                    PEGTL_NS::must<VariantStatementListOpen,
...
struct PrimItem
    : PEGTL_NS::sor<
              PEGTL_NS::seq<PEGTL_NS::sor<ChildOrPropertyOrderStatement, PropertySpec>,
                            PEGTL_NS::star<SinglelinePadding>,
                            StatementSeparator>,
              PEGTL_NS::seq<PEGTL_NS::sor<PrimSpec, VariantSetStatement>, PEGTL_NS::star<SinglelinePadding>, Eol>> {};

// PrimContents = (NewLines)? ((TokenSeparator)? PrimItem)*
struct PrimContents
    : PEGTL_NS::seq<PEGTL_NS::star<MultilinePadding>, PEGTL_NS::star<PrimItem, PEGTL_NS::star<MultilinePadding>>> {};

// PrimTypeName = Identifier ((TokenSeparator)? . (TokenSeparator)? Identifier)*
struct PrimTypeName : PEGTL_NS::list<Identifier, Sdf_PathParser::Dot, InlinePadding> {};
...
//            (TokenSeparator)? }
struct PrimMetadataOptional : PEGTL_NS::pad_opt<PrimMetadata, MultilinePadding> {};
struct PrimSpec : PEGTL_NS::seq<PEGTL_NS::sor<KeywordDef, KeywordOver, KeywordClass>,
                                TokenSeparator,
                                PEGTL_NS::opt<PrimTypeName, TokenSeparator>,
                                String,
                                PrimMetadataOptional,
                                LeftBrace,
                                PEGTL_NS::must<PrimContents, RightBrace>> {};
...
struct SublayerItem : PEGTL_NS::seq<AssetRef,
                                    PEGTL_NS::star<InlinePadding>,
                                    PEGTL_NS::opt<LeftParen,
                                                  PEGTL_NS::pad_opt<StatementSequenceOf<LayerOffset>, MultilinePadding>,
...
struct SublayerMetadata : PEGTL_NS::seq<KeywordSubLayers,
                                        Assignment,
                                        SublayerListOpen,
...
//                     SublayerMetadata
struct LayerMetadataItem : PEGTL_NS::sor<LayerSharedWithListOpMetadata, RelocatesMetadata, SublayerMetadata> {};
...
struct LayerHeader : PEGTL_NS::must<PEGTL_NS::one<'#'>, PEGTL_NS::until<Eolf>> {};
...
struct LayerSpec
    : PEGTL_NS::seq<LayerHeader,
                    ...
                    PEGTL_NS::star<PEGTL_NS::sor<PEGTL_NS::seq<KeywordReorder,
                                                               TokenSeparator,
                                                               KeywordRootPrims,
                                                               Assignment,
                                                               NameList,
                                                 ...
                                                 PEGTL_NS::seq<PrimSpec, PEGTL_NS::star<SinglelinePadding>, Eolf>,
                                                 MultilinePadding>>> {};

// LayerMetadataOnly = LayerHeader (LayerMetadata)?
// production used to interrogate layer metadata without reading the entire
// layer
struct LayerMetadataOnly : PEGTL_NS::seq<LayerHeader, PEGTL_NS::pad_opt<LayerMetadata, MultilinePadding>> {};

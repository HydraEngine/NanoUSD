...
private:
    ...
    static size_t _Hash(const T& self) { return TfHash()(self); }
    ...
    static void _Wrap(const std::string& name) {
        ...
        class_<T>(name.c_str())
                ...
                .def("Create", &T::Create,
                     (arg("prependedItems") = ItemVector(), arg("appendedItems") = ItemVector(),
                ...
                .add_property("explicitItems",
                              ...
                              &T::SetExplicitItems)
                .add_property("addedItems", make_function(&T::GetAddedItems, return_value_policy<return_by_value>()),
                              &T::SetAddedItems)
    ...
    static std::string _GetStr(const T& listOp) { return TfStringify(listOp); }
};

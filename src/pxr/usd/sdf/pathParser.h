...
struct Utf8IdentifierStart : PEGTL_NS::sor<PEGTL_NS::one<'_'>, XidStart> {};
struct Utf8Identifier : PEGTL_NS::seq<Utf8IdentifierStart, PEGTL_NS::star<XidContinue>> {};
...
struct VariantSetName
    : PEGTL_NS::seq<Utf8IdentifierStart, PEGTL_NS::star<PEGTL_NS::sor<XidContinue, PEGTL_NS::one<'-'>>>> {};

struct VariantName : PEGTL_NS::seq<PEGTL_NS::opt<PEGTL_NS::one<'.'>>,
...
struct VariantSelection : PEGTL_NS::if_must<VarSelOpen,
                                            VariantSetName,
                                            PEGTL_NS::pad<PEGTL_NS::one<'='>, PEGTL_NS::blank>,
                                            PEGTL_NS::opt<VariantName>,
                                            VarSelClose> {};

struct VariantSelections : PEGTL_NS::plus<VariantSelection> {};

template <class Rule, class Sep>
struct LookaheadList : PEGTL_NS::seq<Rule, PEGTL_NS::star<PEGTL_NS::at<Sep, Rule>, Sep, Rule>> {};

struct PrimElts : PEGTL_NS::seq<LookaheadList<PrimName, PEGTL_NS::sor<Slash, VariantSelections>>,
...
struct MapperPathSeq
    : PEGTL_NS::if_must<PEGTL_NS::seq<Dot, MapperKW>, BracketPath<MapperPath>, PEGTL_NS::opt<Dot, MapperArg>> {};
...
struct RelAttrSeq
    : PEGTL_NS::if_must<
              PEGTL_NS::one<'.'>,
              RelationalAttributeName,
              PEGTL_NS::opt<
                      PEGTL_NS::sor<BracketPath<TargetPath>, MapperPathSeq, PEGTL_NS::if_must<Dot, Expression>>>> {};

struct TargetPathSeq : PEGTL_NS::seq<BracketPath<TargetPath>, PEGTL_NS::opt<RelAttrSeq>> {};

struct PropElts
    : PEGTL_NS::seq<PEGTL_NS::one<'.'>,
                    PropertyName,
                    PEGTL_NS::opt<PEGTL_NS::sor<TargetPathSeq, MapperPathSeq, PEGTL_NS::if_must<Dot, Expression>>>> {};
...
struct Path : PEGTL_NS::sor<PEGTL_NS::seq<AbsoluteRoot, PEGTL_NS::opt<PrimFirstPathElts>>,

...
void SdfLayerStateDelegateBase::SetFieldDictValueByKey(
        const SdfPath& path, const TfToken& field, const TfToken& keyPath, const VtValue& value, VtValue* oldValue) {
...
void SdfLayerStateDelegateBase::PushChild(const SdfPath& parentPath, const TfToken& field, const TfToken& value) {
    _OnPushChild(parentPath, field, value);
    _layer->_PrimPushChild(parentPath, field, value, /* useDelegate = */ false);
}

void SdfLayerStateDelegateBase::PushChild(const SdfPath& parentPath, const TfToken& field, const SdfPath& value) {
    _OnPushChild(parentPath, field, value);
    _layer->_PrimPushChild(parentPath, field, value, /* useDelegate = */ false);
}

void SdfLayerStateDelegateBase::PopChild(const SdfPath& parentPath, const TfToken& field, const TfToken& oldValue) {
    _OnPopChild(parentPath, field, oldValue);
    _layer->_PrimPopChild<TfToken>(parentPath, field,
                                   /* useDelegate = */ false);
}

void SdfLayerStateDelegateBase::PopChild(const SdfPath& parentPath, const TfToken& field, const SdfPath& oldValue) {
    _OnPopChild(parentPath, field, oldValue);
...
void SdfSimpleLayerStateDelegate::_OnSetField(const SdfPath& path, const TfToken& fieldName, const VtValue& value) {
    _dirty = true;
}

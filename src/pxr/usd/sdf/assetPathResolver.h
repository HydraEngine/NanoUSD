...
/// configuration.
bool Sdf_CanCreateNewLayerWithIdentifier(const std::string& identifier, std::string* whyNot);
...
/// if it's non-nullptr.
ArResolvedPath Sdf_ResolvePath(const std::string& layerPath, ArAssetInfo* assetInfo = nullptr);
...
Sdf_AssetInfo* Sdf_ComputeAssetInfoFromIdentifier(const std::string& identifier,
...
/// empty string.
std::string Sdf_GetAnonLayerDisplayName(const std::string& identifier);
...
bool Sdf_StripIdentifierArgumentsIfPresent(const std::string& identifier, std::string* strippedIdentifier);
...
/// Sdf_SplitIdentifier.
std::string Sdf_CreateIdentifier(const std::string& layerPath, const std::string& arguments);

/// Joins the given \p layerPath and \p arguments into an identifier.
std::string Sdf_CreateIdentifier(const std::string& layerPath, const SdfLayer::FileFormatArguments& arguments);

/// Returns true if the given layer \p identifier contains any file
/// format arguments.
bool Sdf_IdentifierContainsArguments(const std::string& identifier);
...
std::string Sdf_GetLayerDisplayName(const std::string& identifier);

/// Returns the extension of the given identifier used to identify the
/// associated file format.
std::string Sdf_GetExtension(const std::string& identifier);

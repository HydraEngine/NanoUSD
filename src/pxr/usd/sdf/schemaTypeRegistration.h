...
#define _SDF_FIELDS                                                                                                 \
    ((SdfFieldKeys->Active, bool))((SdfFieldKeys->AllowedTokens, VtTokenArray))(                                    \
            ...
            (SdfFieldKeys->Spline, TsSpline))((SdfFieldKeys->StartFrame, double))(                                  \
...
#define _SDF_REGISTER_FIELDS(unused, elem) reg->template RegisterField<_SDF_FIELDS_TYPE(elem)>(_SDF_FIELDS_NAME(elem));

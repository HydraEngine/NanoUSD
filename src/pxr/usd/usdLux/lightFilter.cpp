...
UsdAttribute UsdLuxLightFilter::CreateShaderIdAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdLuxTokens->lightFilterShaderId, SdfValueTypeNames->Token,

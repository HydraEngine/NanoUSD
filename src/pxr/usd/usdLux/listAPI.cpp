...
/* static */
bool UsdLuxListAPI::CanApply(const UsdPrim& prim, std::string* whyNot) {
...
UsdAttribute UsdLuxListAPI::CreateLightListCacheBehaviorAttr(VtValue const& defaultValue, bool writeSparsely) const {

...
public:
    ...
    ///
    USDLUX_API
    static UsdLuxLightFilter Get(const UsdStagePtr& stage, const SdfPath& path);
    ...
    ///
    USDLUX_API
    static UsdLuxLightFilter Define(const UsdStagePtr& stage, const SdfPath& path);
...
public:
    ...
    USDLUX_API
    UsdAttribute GetShaderIdAttrForRenderContext(const TfToken& renderContext) const;
    ...
    /// the default for \p writeSparsely is \c false.
    USDLUX_API
    UsdAttribute CreateShaderIdAttrForRenderContext(const TfToken& renderContext,

...
struct UsdLuxTokensType {
    ...
    ///
    /// Possible value for UsdLuxLightListAPI::GetLightListCacheBehaviorAttr(), Possible value for
    /// UsdLuxListAPI::GetLightListCacheBehaviorAttr()
    ...
    /// \brief "lightLink"
    ///
    ///  This token represents the collection name to use with UsdCollectionAPI to represent light-linking of a prim
    ...
    ///
    /// UsdLuxLightAPI, UsdLuxMeshLightAPI, UsdLuxVolumeLightAPI, UsdLuxDistantLight, UsdLuxDiskLight, UsdLuxRectLight,
    /// UsdLuxSphereLight, UsdLuxCylinderLight, UsdLuxGeometryLight, UsdLuxDomeLight, UsdLuxDomeLight_1,
    /// UsdLuxPortalLight
    const TfToken lightShaderId;
    /// \brief "materialGlowTintsLight"
    ///
    /// Possible value for UsdLuxLightAPI::GetMaterialSyncModeAttr(), Fallback value for UsdLuxMeshLightAPI schema
    /// attribute light:materialSyncMode, Fallback value for UsdLuxVolumeLightAPI schema attribute
    ...
    /// \brief "CylinderLight"
    ///
    /// Schema identifer and family for UsdLuxCylinderLight, Fallback value for UsdLuxCylinderLight schema attribute
    /// light:shaderId
    const TfToken CylinderLight;
    /// \brief "DiskLight"
    ///
    /// Schema identifer and family for UsdLuxDiskLight, Fallback value for UsdLuxDiskLight schema attribute
    /// light:shaderId
    const TfToken DiskLight;
    /// \brief "DistantLight"
    ///
    /// Schema identifer and family for UsdLuxDistantLight, Fallback value for UsdLuxDistantLight schema attribute
    /// light:shaderId
    const TfToken DistantLight;
    /// \brief "DomeLight"
    ///
    /// Schema identifer and family for UsdLuxDomeLight, Schema family for UsdLuxDomeLight_1, Fallback value for
    /// UsdLuxDomeLight schema attribute light:shaderId, Fallback value for UsdLuxDomeLight_1 schema attribute
    /// light:shaderId
    ...
    /// \brief "GeometryLight"
    ///
    /// Schema identifer and family for UsdLuxGeometryLight, Fallback value for UsdLuxGeometryLight schema attribute
    /// light:shaderId
    ...
    /// \brief "PortalLight"
    ///
    /// Schema identifer and family for UsdLuxPortalLight, Fallback value for UsdLuxPortalLight schema attribute
    /// light:shaderId
    const TfToken PortalLight;
    /// \brief "RectLight"
    ///
    /// Schema identifer and family for UsdLuxRectLight, Fallback value for UsdLuxRectLight schema attribute
    /// light:shaderId
    ...
    /// \brief "SphereLight"
    ///
    /// Schema identifer and family for UsdLuxSphereLight, Fallback value for UsdLuxSphereLight schema attribute
    /// light:shaderId

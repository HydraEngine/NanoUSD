...
UsdAttribute UsdLuxCylinderLight::CreateLengthAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdLuxTokens->inputsLength, SdfValueTypeNames->Float,
...
UsdAttribute UsdLuxCylinderLight::CreateTreatAsLineAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdLuxTokens->treatAsLine, SdfValueTypeNames->Bool,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}

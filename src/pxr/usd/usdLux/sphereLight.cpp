...
TF_REGISTRY_FUNCTION(TfType) {
    TfType::Define<UsdLuxSphereLight, TfType::Bases<UsdLuxBoundableLightBase>>();
...
UsdLuxSphereLight UsdLuxSphereLight::Define(const UsdStagePtr& stage, const SdfPath& path) {
    ...
    return UsdLuxSphereLight(stage->DefinePrim(path, usdPrimTypeName));
}
...
UsdAttribute UsdLuxSphereLight::CreateRadiusAttr(VtValue const& defaultValue, bool writeSparsely) const {
...
UsdAttribute UsdLuxSphereLight::GetTreatAsPointAttr() const {
    return GetPrim().GetAttribute(UsdLuxTokens->treatAsPoint);
}

UsdAttribute UsdLuxSphereLight::CreateTreatAsPointAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdLuxTokens->treatAsPoint, SdfValueTypeNames->Bool,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}
...
/*static*/
const TfTokenVector& UsdLuxSphereLight::GetSchemaAttributeNames(bool includeInherited) {

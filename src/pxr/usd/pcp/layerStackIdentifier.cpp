...
bool PcpLayerStackIdentifier::operator==(const This& rhs) const {
    return std::tie(_hash, rootLayer, sessionLayer, pathResolverContext, expressionVariablesOverrideSource) ==
           std::tie(rhs._hash, rhs.rootLayer, rhs.sessionLayer, rhs.pathResolverContext,
                    rhs.expressionVariablesOverrideSource);
}

bool PcpLayerStackIdentifier::operator<(const This& rhs) const {
    return std::tie(sessionLayer, rootLayer, pathResolverContext, expressionVariablesOverrideSource) <
           std::tie(rhs.sessionLayer, rhs.rootLayer, rhs.pathResolverContext, rhs.expressionVariablesOverrideSource);
}

size_t PcpLayerStackIdentifier::_ComputeHash() const {
    return TfHash::Combine(rootLayer, sessionLayer, pathResolverContext, expressionVariablesOverrideSource);
}
...
static long Pcp_IdentifierFormatIndex() {
...
static void _PrintIdentifier(std::ostream& s, const PcpLayerStackIdentifier& x) {

...
static SdfPath Pcp_TranslatePath(const Mapping& mapToRoot, const SdfPath& path, bool* pathWasTranslated) {
    ...
    *pathWasTranslated = false;
    ...
    SdfPath translatedPath = NodeToRoot ? mapToRoot.MapSourceToTarget(path) : mapToRoot.MapTargetToSource(path);
    ...
    TF_FOR_ALL(targetPathIt, targetPaths) {
        ...
        const SdfPath translatedTargetPath =
                NodeToRoot ? mapToRoot.MapSourceToTarget(targetPath) : mapToRoot.MapTargetToSource(targetPath);
...
SdfPath PcpTranslatePathFromNodeToRoot(const PcpNodeRef& sourceNode,
    ...
    return Pcp_TranslatePath</* NodeToRoot = */ true>(sourceNode.GetMapToRoot(), pathToTranslate, pathWasTranslated);
}
...
SdfPath PcpTranslatePathFromRootToNode(const PcpNodeRef& destNode,
    ...
    SdfPath translatedPath = Pcp_TranslatePath</* NodeToRoot = */ false>(destNode.GetMapToRoot(), pathInRootNamespace,
...
SdfPath PcpTranslateTargetPathFromRootToNode(const PcpNodeRef& destNode,
    ...
    return Pcp_TranslatePath</* NodeToRoot = */ false>(destNode.GetMapToRoot(), pathInRootNamespace, pathWasTranslated);
}

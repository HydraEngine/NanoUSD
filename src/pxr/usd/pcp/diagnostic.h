...
PCP_API
std::string PcpDump(const PcpPrimIndex& primIndex, bool includeInheritOriginInfo = false, bool includeMaps = false);
...
public:
    ...
    Pcp_IndexingPhaseScope(Pcp_IndexingPhaseScope&& other) : _index(other._index) { other._index = nullptr; }
...
void Pcp_IndexingMsg(PcpPrimIndex const* index, const PcpNodeRef& a1, char const* fmt, ...) ARCH_PRINTF_FUNCTION(3, 4);

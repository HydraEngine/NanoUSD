...
PcpExpressionVariablesSource::PcpExpressionVariablesSource(const PcpLayerStackIdentifier& layerStackIdentifier,
...
const PcpLayerStackIdentifier& PcpExpressionVariablesSource::ResolveLayerStackIdentifier(const PcpCache& cache) const {

...
public:
    ...
    ///
    PCP_API
    PcpLayerRelocatesEditBuilder(const PcpLayerStackPtr& layerStack,
    ...
    ///
    PCP_API
    bool Relocate(const SdfPath& sourcePath, const SdfPath& targetPath, std::string* whyNot = nullptr);
    ...
    ///
    PCP_API
    bool RemoveRelocate(const SdfPath& sourcePath, std::string* whyNot = nullptr);
...
private:
    void _UpdateExistingRelocates(const SdfPath& source, const SdfPath& target);

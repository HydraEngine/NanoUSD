...
NdrNodeUniquePtr NdrParserPlugin::GetInvalidNode(const NdrNodeDiscoveryResult& dr) {
    ...
    return NdrNodeUniquePtr(new NdrNode(dr.identifier, dr.version, dr.name, dr.family,
                                        TfToken("unknown discovery type"), TfToken("unknown source type"),
                                        dr.resolvedUri, dr.resolvedUri,

...
UsdRiTokensType::UsdRiTokensType()
    : bspline("bspline", TfToken::Immortal),
      ...
      allTokens({bspline, cameraVisibility, catmullRom, collectionCameraVisibilityIncludeRoot, constant, interpolation,
                 linear, matte, outputsRiDisplacement, outputsRiSurface, outputsRiVolume, positions, renderContext,
                 spline, values, RiMaterialAPI, RiRenderPassAPI, RiSplineAPI, StatementsAPI}) {}

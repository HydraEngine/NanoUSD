...
struct UsdRiTokensType {
    ...
    ///
    ///  UsdRenderPassAPI - This token represents the collection  name to use with UsdCollectionAPI to set the camera
    ///  visibility attribute on the prims in the collection for the RenderPass.
    ...
    /// \brief "matte"
    ///
    ///  UsdRenderPassAPI - This token represents the collection  name to use with UsdCollectionAPI to set the matte

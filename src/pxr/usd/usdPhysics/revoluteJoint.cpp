...
UsdAttribute UsdPhysicsRevoluteJoint::CreateLowerLimitAttr(VtValue const& defaultValue, bool writeSparsely) const {
...
UsdAttribute UsdPhysicsRevoluteJoint::CreateUpperLimitAttr(VtValue const& defaultValue, bool writeSparsely) const {

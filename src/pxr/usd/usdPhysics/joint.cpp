...
UsdAttribute UsdPhysicsJoint::CreateLocalPos0Attr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdPhysicsTokens->physicsLocalPos0, SdfValueTypeNames->Point3f,
...
UsdAttribute UsdPhysicsJoint::CreateLocalRot0Attr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdPhysicsTokens->physicsLocalRot0, SdfValueTypeNames->Quatf,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}
...
UsdAttribute UsdPhysicsJoint::CreateLocalPos1Attr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdPhysicsTokens->physicsLocalPos1, SdfValueTypeNames->Point3f,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}
...
UsdAttribute UsdPhysicsJoint::CreateLocalRot1Attr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdPhysicsTokens->physicsLocalRot1, SdfValueTypeNames->Quatf,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}
...
UsdAttribute UsdPhysicsJoint::CreateJointEnabledAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdPhysicsTokens->physicsJointEnabled, SdfValueTypeNames->Bool,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}
...
UsdAttribute UsdPhysicsJoint::CreateCollisionEnabledAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdPhysicsTokens->physicsCollisionEnabled, SdfValueTypeNames->Bool,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}
...
UsdAttribute UsdPhysicsJoint::CreateExcludeFromArticulationAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdPhysicsTokens->physicsExcludeFromArticulation, SdfValueTypeNames->Bool,
...
UsdAttribute UsdPhysicsJoint::CreateBreakForceAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdPhysicsTokens->physicsBreakForce, SdfValueTypeNames->Float,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}
...
UsdAttribute UsdPhysicsJoint::CreateBreakTorqueAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdPhysicsTokens->physicsBreakTorque, SdfValueTypeNames->Float,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}

...
struct UsdPhysicsTokensType {
    ...
    /// UsdPhysicsPrismaticJoint::GetAxisAttr(), Fallback value for UsdPhysicsSphericalJoint::GetAxisAttr()
    const TfToken x;
    /// \brief "Y"
    ///
    /// Possible value for UsdPhysicsRevoluteJoint::GetAxisAttr(), Possible value for
    /// UsdPhysicsPrismaticJoint::GetAxisAttr(), Possible value for UsdPhysicsSphericalJoint::GetAxisAttr()
    const TfToken y;
    /// \brief "Z"
    ///
    /// Possible value for UsdPhysicsRevoluteJoint::GetAxisAttr(), Possible value for

...
UsdAttribute UsdPhysicsSphericalJoint::CreateConeAngle0LimitAttr(VtValue const& defaultValue,
    ...
    return UsdSchemaBase::_CreateAttr(UsdPhysicsTokens->physicsConeAngle0Limit, SdfValueTypeNames->Float,
...
UsdAttribute UsdPhysicsSphericalJoint::CreateConeAngle1LimitAttr(VtValue const& defaultValue,
                                                                 bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdPhysicsTokens->physicsConeAngle1Limit, SdfValueTypeNames->Float,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}

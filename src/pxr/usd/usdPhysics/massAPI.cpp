...
UsdAttribute UsdPhysicsMassAPI::CreateMassAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdPhysicsTokens->physicsMass, SdfValueTypeNames->Float,
...
UsdAttribute UsdPhysicsMassAPI::CreateDensityAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdPhysicsTokens->physicsDensity, SdfValueTypeNames->Float,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}
...
UsdAttribute UsdPhysicsMassAPI::CreateCenterOfMassAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdPhysicsTokens->physicsCenterOfMass, SdfValueTypeNames->Point3f,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}
...
UsdAttribute UsdPhysicsMassAPI::CreateDiagonalInertiaAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdPhysicsTokens->physicsDiagonalInertia, SdfValueTypeNames->Float3,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}
...
UsdAttribute UsdPhysicsMassAPI::CreatePrincipalAxesAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdPhysicsTokens->physicsPrincipalAxes, SdfValueTypeNames->Quatf,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}
...
const TfTokenVector& UsdPhysicsMassAPI::GetSchemaAttributeNames(bool includeInherited) {
    static TfTokenVector localNames = {
            UsdPhysicsTokens->physicsMass,          UsdPhysicsTokens->physicsDensity,
            UsdPhysicsTokens->physicsCenterOfMass,  UsdPhysicsTokens->physicsDiagonalInertia,

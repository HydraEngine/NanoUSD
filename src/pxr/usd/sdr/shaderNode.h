...
#define SDR_NODE_METADATA_TOKENS                                                                              \
    ((Category, "category"))((Role, "role"))((Departments, "departments"))((Help, "help"))((Label, "label"))( \
            (Pages, "pages"))((Primvars, "primvars"))((ImplementationName, "__SDR__implementationName"))(     \
            (Target, "__SDR__target"))((SdrUsdEncodingVersion, "sdrUsdEncodingVersion"))(                     \
...
#define SDR_NODE_CONTEXT_TOKENS                                                                       \
    ((Pattern, "pattern"))((Surface, "surface"))((Volume, "volume"))((Displacement, "displacement"))( \
            (Light, "light"))((DisplayFilter, "displayFilter"))((LightFilter, "lightFilter"))(        \
            (PixelFilter, "pixelFilter"))((SampleFilter, "sampleFilter"))
...
public:
    ...
    SDR_API
    const NdrTokenVec& GetAdditionalPrimvarProperties() const { return _primvarNamingProperties; }
    ...
    using ComplianceResults = std::unordered_map<TfToken, std::vector<NdrIdentifier>, TfToken::HashFunctor>;
    ...
    SDR_API
    static ComplianceResults CheckPropertyCompliance(const std::vector<SdrShaderNodeConstPtr>& shaderNodes);

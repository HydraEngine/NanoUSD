...
#define SDR_PROPERTY_TYPE_TOKENS                                                                                     \
    ((Int, "int"))((String, "string"))((Float, "float"))((Color, "color"))((Color4, "color4"))((Point, "point"))(    \
            (Normal, "normal"))((Vector, "vector"))((Matrix, "matrix"))((Struct, "struct"))((Terminal, "terminal"))( \
            (Vstruct, "vstruct"))((Unknown, "unknown"))
...
#define SDR_PROPERTY_METADATA_TOKENS                                                                              \
    ((Label, "label"))((Help, "help"))((Page, "page"))((RenderType, "renderType"))((Role, "role"))(               \
            (Widget, "widget"))((Hints, "hints"))((Options, "options"))((IsDynamicArray, "isDynamicArray"))(      \
            (Connectable, "connectable"))((Tag, "tag"))((ValidConnectionTypes, "validConnectionTypes"))(          \
            (VstructMemberOf, "vstructMemberOf"))((VstructMemberName, "vstructMemberName"))(                      \
            (VstructConditionalExpr, "vstructConditionalExpr"))((IsAssetIdentifier, "__SDR__isAssetIdentifier"))( \
            (ImplementationName, "__SDR__implementationName"))((SdrUsdDefinitionType, "sdrUsdDefinitionType"))(   \
            (DefaultInput, "__SDR__defaultinput"))((Target, "__SDR__target"))((Colorspace, "__SDR__colorspace"))
...
public:
    // Constructor.
    SDR_API
    SdrShaderProperty(const TfToken& name,
                      const TfToken& type,
    ...
    SDR_API
    const TfToken& GetVStructMemberOf() const { return _vstructMemberOf; }

    /// If this field is part of a vstruct, this is its name in the struct.
    SDR_API
    const TfToken& GetVStructMemberName() const { return _vstructMemberName; }
    ...
    SDR_API
    const TfToken& GetVStructConditionalExpr() const { return _vstructConditionalExpr; }
    ...
    SDR_API
    const NdrTokenVec& GetValidConnectionTypes() const { return _validConnectionTypes; }
    ...
    /// \sa GetTypeAsSdfType
    SDR_API
    const VtValue& GetDefaultValueAsSdfType() const override { return _sdfTypeDefaultValue; }

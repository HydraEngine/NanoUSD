...
UsdMediaTokensType::UsdMediaTokensType()
    : auralMode("auralMode", TfToken::Immortal),
      ...
      allTokens({auralMode,    defaultImage,  endTime,           filePath,
                 gain,         loopFromStage, loopFromStart,     loopFromStartToEnd,
                 mediaOffset,  nonSpatial,    onceFromStart,     onceFromStartToEnd,
                 playbackMode, previews,      previewThumbnails, previewThumbnailsDefault,
                 spatial,      startTime,     thumbnails,        AssetPreviewsAPI,
                 SpatialAudio}) {}

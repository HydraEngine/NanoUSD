...
UsdAttribute UsdMediaSpatialAudio::CreateFilePathAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdMediaTokens->filePath, SdfValueTypeNames->Asset,
...
UsdAttribute UsdMediaSpatialAudio::CreateAuralModeAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdMediaTokens->auralMode, SdfValueTypeNames->Token,
                                      /* custom = */ false, SdfVariabilityUniform, defaultValue, writeSparsely);
}
...
UsdAttribute UsdMediaSpatialAudio::CreatePlaybackModeAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdMediaTokens->playbackMode, SdfValueTypeNames->Token,
                                      /* custom = */ false, SdfVariabilityUniform, defaultValue, writeSparsely);
}
...
UsdAttribute UsdMediaSpatialAudio::CreateStartTimeAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdMediaTokens->startTime, SdfValueTypeNames->TimeCode,
                                      /* custom = */ false, SdfVariabilityUniform, defaultValue, writeSparsely);
}
...
UsdAttribute UsdMediaSpatialAudio::CreateEndTimeAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdMediaTokens->endTime, SdfValueTypeNames->TimeCode,
                                      /* custom = */ false, SdfVariabilityUniform, defaultValue, writeSparsely);
}
...
UsdAttribute UsdMediaSpatialAudio::CreateMediaOffsetAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdMediaTokens->mediaOffset, SdfValueTypeNames->Double,
                                      /* custom = */ false, SdfVariabilityUniform, defaultValue, writeSparsely);
}
...
UsdAttribute UsdMediaSpatialAudio::CreateGainAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdMediaTokens->gain, SdfValueTypeNames->Double,
...
const TfTokenVector& UsdMediaSpatialAudio::GetSchemaAttributeNames(bool includeInherited) {
    static TfTokenVector localNames = {
            UsdMediaTokens->filePath,  UsdMediaTokens->auralMode, UsdMediaTokens->playbackMode,
            UsdMediaTokens->startTime, UsdMediaTokens->endTime,   UsdMediaTokens->mediaOffset,
            UsdMediaTokens->gain,
    };

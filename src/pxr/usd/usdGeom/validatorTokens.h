...
#define USD_GEOM_VALIDATOR_NAME_TOKENS                                                                    \
    ((stageMetadataChecker, "usdGeom:StageMetadataChecker"))((subsetFamilies, "usdGeom:SubsetFamilies"))( \
            (subsetParentIsImageable, "usdGeom:SubsetParentIsImageable"))

#define USD_GEOM_VALIDATOR_KEYWORD_TOKENS (UsdGeomSubset)(UsdGeomValidators)

#define USD_GEOM_VALIDATION_ERROR_NAME_TOKENS                                                                \
    ((missingMetersPerUnitMetadata, "MissingMetersPerUnitMetadata"))(                                        \
            (missingUpAxisMetadata, "MissingUpAxisMetadata"))((invalidSubsetFamily, "InvalidSubsetFamily"))( \
...
/// the usdGeom plugin.
TF_DECLARE_PUBLIC_TOKENS(UsdGeomValidatorNameTokens, USDGEOM_API, USD_GEOM_VALIDATOR_NAME_TOKENS);
...
/// validator.
TF_DECLARE_PUBLIC_TOKENS(UsdGeomValidatorKeywordTokens, USDGEOM_API, USD_GEOM_VALIDATOR_KEYWORD_TOKENS);

/// \def USD_GEOM_VALIDATION_ERROR_NAME_TOKENS
/// Tokens representing validation error identifier.
TF_DECLARE_PUBLIC_TOKENS(UsdGeomValidationErrorNameTokens, USDGEOM_API, USD_GEOM_VALIDATION_ERROR_NAME_TOKENS);

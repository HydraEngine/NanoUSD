...
UsdAttribute UsdGeomMotionAPI::CreateMotionBlurScaleAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdGeomTokens->motionBlurScale, SdfValueTypeNames->Float,
...
UsdAttribute UsdGeomMotionAPI::CreateVelocityScaleAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdGeomTokens->motionVelocityScale, SdfValueTypeNames->Float,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}
...
UsdAttribute UsdGeomMotionAPI::CreateNonlinearSampleCountAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdGeomTokens->motionNonlinearSampleCount, SdfValueTypeNames->Int,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}
...
float UsdGeomMotionAPI::ComputeVelocityScale(UsdTimeCode time) const {
    return _ComputeInheritedMotionAttr<float>(GetPrim(), UsdGeomTokens->motionVelocityScale, 1.0, time);
}

int UsdGeomMotionAPI::ComputeNonlinearSampleCount(UsdTimeCode time) const {
    return _ComputeInheritedMotionAttr<int>(GetPrim(), UsdGeomTokens->motionNonlinearSampleCount, 3, time);
}

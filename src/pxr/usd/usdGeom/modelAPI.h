...
public:
    ...
    ///
    USDGEOM_API
    static UsdGeomModelAPI Get(const UsdStagePtr& stage, const SdfPath& path);
...
public:
    ...
    ///
    USDGEOM_API
    UsdGeomConstraintTarget GetConstraintTarget(const std::string& constraintName) const;
    ...
    ///
    USDGEOM_API
    UsdGeomConstraintTarget CreateConstraintTarget(const std::string& constraintName) const;

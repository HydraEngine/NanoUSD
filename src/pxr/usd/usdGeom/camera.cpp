...
TF_REGISTRY_FUNCTION(TfType) {
    TfType::Define<UsdGeomCamera, TfType::Bases<UsdGeomXformable>>();
...
UsdGeomCamera UsdGeomCamera::Define(const UsdStagePtr& stage, const SdfPath& path) {
    ...
    return UsdGeomCamera(stage->DefinePrim(path, usdPrimTypeName));
}
...
UsdAttribute UsdGeomCamera::CreateProjectionAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdGeomTokens->projection, SdfValueTypeNames->Token,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}

UsdAttribute UsdGeomCamera::GetHorizontalApertureAttr() const {
    return GetPrim().GetAttribute(UsdGeomTokens->horizontalAperture);
}

UsdAttribute UsdGeomCamera::CreateHorizontalApertureAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdGeomTokens->horizontalAperture, SdfValueTypeNames->Float,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}

UsdAttribute UsdGeomCamera::GetVerticalApertureAttr() const {
...
UsdAttribute UsdGeomCamera::CreateVerticalApertureAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdGeomTokens->verticalAperture, SdfValueTypeNames->Float,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}

UsdAttribute UsdGeomCamera::GetHorizontalApertureOffsetAttr() const {
    return GetPrim().GetAttribute(UsdGeomTokens->horizontalApertureOffset);
}

UsdAttribute UsdGeomCamera::CreateHorizontalApertureOffsetAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdGeomTokens->horizontalApertureOffset, SdfValueTypeNames->Float,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}

UsdAttribute UsdGeomCamera::GetVerticalApertureOffsetAttr() const {
    return GetPrim().GetAttribute(UsdGeomTokens->verticalApertureOffset);
}

UsdAttribute UsdGeomCamera::CreateVerticalApertureOffsetAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdGeomTokens->verticalApertureOffset, SdfValueTypeNames->Float,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}

UsdAttribute UsdGeomCamera::GetFocalLengthAttr() const {
...
UsdAttribute UsdGeomCamera::CreateFocalLengthAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdGeomTokens->focalLength, SdfValueTypeNames->Float,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}

UsdAttribute UsdGeomCamera::GetClippingRangeAttr() const {
...
UsdAttribute UsdGeomCamera::CreateClippingRangeAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdGeomTokens->clippingRange, SdfValueTypeNames->Float2,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}

UsdAttribute UsdGeomCamera::GetClippingPlanesAttr() const {
...
UsdAttribute UsdGeomCamera::CreateClippingPlanesAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdGeomTokens->clippingPlanes, SdfValueTypeNames->Float4Array,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}

UsdAttribute UsdGeomCamera::GetFStopAttr() const {
    return GetPrim().GetAttribute(UsdGeomTokens->fStop);
}

UsdAttribute UsdGeomCamera::CreateFStopAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdGeomTokens->fStop, SdfValueTypeNames->Float,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}

UsdAttribute UsdGeomCamera::GetFocusDistanceAttr() const {
...
UsdAttribute UsdGeomCamera::CreateFocusDistanceAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdGeomTokens->focusDistance, SdfValueTypeNames->Float,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}

UsdAttribute UsdGeomCamera::GetStereoRoleAttr() const {
...
UsdAttribute UsdGeomCamera::CreateStereoRoleAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdGeomTokens->stereoRole, SdfValueTypeNames->Token,
                                      /* custom = */ false, SdfVariabilityUniform, defaultValue, writeSparsely);
}

UsdAttribute UsdGeomCamera::GetShutterOpenAttr() const {
...
UsdAttribute UsdGeomCamera::CreateShutterOpenAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdGeomTokens->shutterOpen, SdfValueTypeNames->Double,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}

UsdAttribute UsdGeomCamera::GetShutterCloseAttr() const {
...
UsdAttribute UsdGeomCamera::CreateShutterCloseAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdGeomTokens->shutterClose, SdfValueTypeNames->Double,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}

UsdAttribute UsdGeomCamera::GetExposureAttr() const {
...
UsdAttribute UsdGeomCamera::CreateExposureAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdGeomTokens->exposure, SdfValueTypeNames->Float,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}
...
template <class T>
static std::optional<T> _GetValue(const UsdPrim& prim, const TfToken& name, const UsdTimeCode& time) {
...
static GfVec2f _Range1fToVec2f(const GfRange1f& range) {
    return GfVec2f(range.GetMin(), range.GetMax());
}

static std::vector<GfVec4f> _VtArrayVec4fToVector(const VtArray<GfVec4f>& array) {
    return std::vector<GfVec4f>(array.begin(), array.end());
}

static VtArray<GfVec4f> _VectorVec4fToVtArray(const std::vector<GfVec4f>& vec) {
    VtArray<GfVec4f> result;
    result.assign(vec.begin(), vec.end());
    return result;
}

GfCamera UsdGeomCamera::GetCamera(const UsdTimeCode& time) const {
    GfCamera camera;

    camera.SetTransform(ComputeLocalToWorldTransform(time));

    if (const std::optional<TfToken> projection = _GetValue<TfToken>(GetPrim(), UsdGeomTokens->projection, time)) {
        camera.SetProjection(_TokenToProjection(*projection));
    }

    if (const std::optional<float> horizontalAperture =
                _GetValue<float>(GetPrim(), UsdGeomTokens->horizontalAperture, time)) {
        camera.SetHorizontalAperture(*horizontalAperture);
    }

    if (const std::optional<float> verticalAperture =
                _GetValue<float>(GetPrim(), UsdGeomTokens->verticalAperture, time)) {
        camera.SetVerticalAperture(*verticalAperture);
    }

    if (const std::optional<float> horizontalApertureOffset =
                _GetValue<float>(GetPrim(), UsdGeomTokens->horizontalApertureOffset, time)) {
        camera.SetHorizontalApertureOffset(*horizontalApertureOffset);
    }

    if (const std::optional<float> verticalApertureOffset =
                _GetValue<float>(GetPrim(), UsdGeomTokens->verticalApertureOffset, time)) {
        camera.SetVerticalApertureOffset(*verticalApertureOffset);
    }

    if (const std::optional<float> focalLength = _GetValue<float>(GetPrim(), UsdGeomTokens->focalLength, time)) {
        camera.SetFocalLength(*focalLength);
    }

    if (const std::optional<GfVec2f> clippingRange =
                _GetValue<GfVec2f>(GetPrim(), UsdGeomTokens->clippingRange, time)) {
        camera.SetClippingRange(_Vec2fToRange1f(*clippingRange));
    }

    if (const std::optional<VtArray<GfVec4f>> clippingPlanes =
                _GetValue<VtArray<GfVec4f>>(GetPrim(), UsdGeomTokens->clippingPlanes, time)) {
        camera.SetClippingPlanes(_VtArrayVec4fToVector(*clippingPlanes));
    }

    if (const std::optional<float> fStop = _GetValue<float>(GetPrim(), UsdGeomTokens->fStop, time)) {
        camera.SetFStop(*fStop);
    }

    if (const std::optional<float> focusDistance = _GetValue<float>(GetPrim(), UsdGeomTokens->focusDistance, time)) {
...
void UsdGeomCamera::SetFromCamera(const GfCamera& camera, const UsdTimeCode& time) {
    const GfMatrix4d parentToWorldInverse = ComputeParentToWorldTransform(time).GetInverse();
    ...
    GetHorizontalApertureOffsetAttr().Set(camera.GetHorizontalApertureOffset(), time);
    GetVerticalApertureOffsetAttr().Set(camera.GetVerticalApertureOffset(), time);
    GetFocalLengthAttr().Set(camera.GetFocalLength(), time);
    GetClippingRangeAttr().Set(_Range1fToVec2f(camera.GetClippingRange()), time);

    GetClippingPlanesAttr().Set(_VectorVec4fToVtArray(camera.GetClippingPlanes()), time);

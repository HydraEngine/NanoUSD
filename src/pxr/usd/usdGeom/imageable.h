...
public:
    ...
    ///
    USDGEOM_API
    static UsdGeomImageable Get(const UsdStagePtr& stage, const SdfPath& path);
...
public:
    ...
    USDGEOM_API
    UsdAttribute GetPurposeVisibilityAttr(const TfToken& purpose = UsdGeomTokens->default_) const;
    ...
    /// \sa ComputeVisibility()
    USDGEOM_API
    TfToken ComputeEffectiveVisibility(const TfToken& purpose = UsdGeomTokens->default_,
    ...
    struct PurposeInfo {
        ...
        PurposeInfo(const TfToken& purpose_, bool isInheritable_) : purpose(purpose_), isInheritable(isInheritable_) {}
        ...
        bool operator==(const PurposeInfo& rhs) { return purpose == rhs.purpose && isInheritable == rhs.isInheritable; }

        bool operator!=(const PurposeInfo& rhs) { return !(*this == rhs); }

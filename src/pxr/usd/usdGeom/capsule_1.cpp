...
TF_REGISTRY_FUNCTION(TfType) {
    TfType::Define<UsdGeomCapsule_1, TfType::Bases<UsdGeomGprim>>();
...
/* static */
UsdGeomCapsule_1 UsdGeomCapsule_1::Get(const UsdStagePtr& stage, const SdfPath& path) {
    if (!stage) {
...
/* static */
UsdGeomCapsule_1 UsdGeomCapsule_1::Define(const UsdStagePtr& stage, const SdfPath& path) {
    static TfToken usdPrimTypeName("Capsule_1");
    if (!stage) {
        TF_CODING_ERROR("Invalid stage");
        return UsdGeomCapsule_1();
    }
    return UsdGeomCapsule_1(stage->DefinePrim(path, usdPrimTypeName));
}
...
/* static */
const TfType& UsdGeomCapsule_1::_GetStaticTfType() {
    static TfType tfType = TfType::Find<UsdGeomCapsule_1>();
    return tfType;
}

/* static */
bool UsdGeomCapsule_1::_IsTypedSchema() {
    static bool isTyped = _GetStaticTfType().IsA<UsdTyped>();
    return isTyped;
}

/* virtual */
const TfType& UsdGeomCapsule_1::_GetTfType() const {
    return _GetStaticTfType();
}

UsdAttribute UsdGeomCapsule_1::GetHeightAttr() const {
    return GetPrim().GetAttribute(UsdGeomTokens->height);
}

UsdAttribute UsdGeomCapsule_1::CreateHeightAttr(VtValue const& defaultValue, bool writeSparsely) const {
...
UsdAttribute UsdGeomCapsule_1::GetRadiusTopAttr() const {
    return GetPrim().GetAttribute(UsdGeomTokens->radiusTop);
}

UsdAttribute UsdGeomCapsule_1::CreateRadiusTopAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdGeomTokens->radiusTop, SdfValueTypeNames->Double,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}

UsdAttribute UsdGeomCapsule_1::GetRadiusBottomAttr() const {
    return GetPrim().GetAttribute(UsdGeomTokens->radiusBottom);
}

UsdAttribute UsdGeomCapsule_1::CreateRadiusBottomAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdGeomTokens->radiusBottom, SdfValueTypeNames->Double,
                                      /* custom = */ false, SdfVariabilityVarying, defaultValue, writeSparsely);
}

UsdAttribute UsdGeomCapsule_1::GetAxisAttr() const {
    return GetPrim().GetAttribute(UsdGeomTokens->axis);
}

UsdAttribute UsdGeomCapsule_1::CreateAxisAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdGeomTokens->axis, SdfValueTypeNames->Token,
                                      /* custom = */ false, SdfVariabilityUniform, defaultValue, writeSparsely);
}

UsdAttribute UsdGeomCapsule_1::GetExtentAttr() const {
    return GetPrim().GetAttribute(UsdGeomTokens->extent);
}

UsdAttribute UsdGeomCapsule_1::CreateExtentAttr(VtValue const& defaultValue, bool writeSparsely) const {
...
/*static*/
const TfTokenVector& UsdGeomCapsule_1::GetSchemaAttributeNames(bool includeInherited) {
...
bool UsdGeomCapsule_1::ComputeExtent(
...
bool UsdGeomCapsule_1::ComputeExtent(double height,
                                     double radiusTop,
                                     double radiusBottom,
                                     const TfToken& axis,
...
static bool _ComputeExtentForCapsule(const UsdGeomBoundable& boundable,
    ...
    if (transform) {
        return UsdGeomCapsule_1::ComputeExtent(height, radiusTop, radiusBottom, axis, *transform, extent);
    } else {
        return UsdGeomCapsule_1::ComputeExtent(height, radiusTop, radiusBottom, axis, extent);
    }
}

TF_REGISTRY_FUNCTION(UsdGeomBoundable) {
    UsdGeomRegisterComputeExtentFunction<UsdGeomCapsule_1>(_ComputeExtentForCapsule);
}

...
public:
    ...
    public:
        ...
        /// direct binding.
        const SdfPath& GetMaterialPath() const { return _materialPath; }

        /// Returns the binding-relationship that represents this direct
        /// binding.
        const UsdRelationship& GetBindingRel() const { return _bindingRel; }

        /// Returns the purpose of the direct binding.
        const TfToken& GetMaterialPurpose() const { return _materialPurpose; }
    ...
    public:
        ...
        /// path and collection.
        bool IsValid() const {
            return CollectionBinding::IsCollectionBindingRel(_bindingRel) && !GetMaterialPath().IsEmpty();
        }
        /// Returns the path to the collection that is bound by this binding.
        const SdfPath& GetCollectionPath() const { return _collectionPath; }
    ...
    /// \ref UsdShadeMaterialBindingAPI_MaterialResolution.
    USDSHADE_API
    CollectionBindingVector GetCollectionBindings(const TfToken& materialPurpose = UsdShadeTokens->allPurpose) const;
    ...
    USDSHADE_API
    static TfToken GetMaterialBindingStrength(const UsdRelationship& bindingRel);
    ...
    /// Returns true on success, false otherwise.
    USDSHADE_API
    bool Bind(const UsdCollectionAPI& collection,
    ...
    USDSHADE_API
    bool UnbindDirectBinding(const TfToken& materialPurpose = UsdShadeTokens->allPurpose) const;
    ...
    /// This does not remove the UsdShadeMaterialBindingAPI schema application.
    USDSHADE_API
    bool UnbindCollectionBinding(const TfToken& bindingName,
                                 const TfToken& materialPurpose = UsdShadeTokens->allPurpose) const;
    ...
    USDSHADE_API
    bool RemovePrimFromBindingCollection(const UsdPrim& prim,
    ...
    USDSHADE_API
    bool AddPrimToBindingCollection(const UsdPrim& prim,
                                    const TfToken& bindingName,
                                    const TfToken& materialPurpose) const;
    ...
    using CollectionQueryCache =
            tbb::concurrent_unordered_map<SdfPath, std::unique_ptr<UsdCollectionAPI::MembershipQuery>, SdfPath::Hash>;
    ...
    struct BindingsAtPrim {
        ...
        ///
        USDSHADE_API
        BindingsAtPrim(const UsdPrim& prim, const TfToken& materialPurpose, bool supportLegacyBindings);
    ...
    USDSHADE_API
    static const SdfPath GetResolvedTargetPathFromBindingRel(const UsdRelationship& bindingRel);
    ...
    USDSHADE_API
    UsdGeomSubset CreateMaterialBindSubset(const TfToken& subsetName,
...
private:
    ...
    UsdRelationship _CreateCollectionBindingRel(const TfToken& bindingName, const TfToken& materialPurpose) const;

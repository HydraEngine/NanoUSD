...
/* static */
UsdShadeConnectableAPI UsdShadeConnectableAPI::Get(const UsdStagePtr& stage, const SdfPath& path) {
    if (!stage) {
...
/*static*/
const TfTokenVector& UsdShadeConnectableAPI::GetSchemaAttributeNames(bool includeInherited) {
...
static UsdAttribute _GetOrCreateSourceAttr(UsdShadeConnectionSourceInfo const& sourceInfo,
    ...
    if (!sourceAttr) {
        sourceAttr = sourcePrim.CreateAttribute(sourceAttrName,
                                                ...
                                                // the fallback
                                                sourceInfo.typeName ? sourceInfo.typeName : fallbackTypeName,
                                                /* custom = */ false);
    }
...
/* static */
bool UsdShadeConnectableAPI::ConnectToSource(UsdAttribute const& shadingAttr,
    ...
    if (!source) {
        TF_CODING_ERROR(
                ...
                shadingAttr.GetPath().GetText(), UsdShadeUtils::GetPrefixForAttributeType(source.sourceType).c_str(),
                source.sourceName.GetText(), source.source.GetPath().GetText());
        return false;
    }
...
/* static */
bool UsdShadeConnectableAPI::ConnectToSource(UsdAttribute const& shadingAttr, SdfPath const& sourcePath) {
    return ConnectToSource(shadingAttr, UsdShadeConnectionSourceInfo(shadingAttr.GetStage(), sourcePath));
}

/* static */
bool UsdShadeConnectableAPI::ConnectToSource(UsdAttribute const& shadingAttr, UsdShadeInput const& sourceInput) {
...
/* static */
bool UsdShadeConnectableAPI::ConnectToSource(UsdAttribute const& shadingAttr, UsdShadeOutput const& sourceOutput) {
...
/* static */
bool UsdShadeConnectableAPI::SetConnectedSources(UsdAttribute const& shadingAttr,
    ...
    for (UsdShadeConnectionSourceInfo const& sourceInfo : sourceInfos) {
        if (!sourceInfo) {
            TF_CODING_ERROR(
                    ...
                    UsdShadeUtils::GetPrefixForAttributeType(sourceInfo.sourceType).c_str(),
                    sourceInfo.sourceName.GetText(), sourceInfo.source.GetPath().GetText());
            return false;
        }
...
/* static */
bool UsdShadeConnectableAPI::GetConnectedSource(UsdAttribute const& shadingAttr,
...
/* static */
UsdShadeSourceInfoVector UsdShadeConnectableAPI::GetConnectedSources(UsdAttribute const& shadingAttr,
    ...
    for (SdfPath const& sourcePath : sourcePaths) {
        ...
        TfToken sourceName;
        UsdShadeAttributeType sourceType;
        std::tie(sourceName, sourceType) = UsdShadeUtils::GetBaseNameAndType(sourcePath.GetNameToken());
...
/* static */
UsdShadeSourceInfoVector UsdShadeConnectableAPI::GetConnectedSources(UsdShadeInput const& input,
                                                                     SdfPathVector* invalidSourcePaths) {
    return GetConnectedSources(input.GetAttr(), invalidSourcePaths);
}

/* static */
UsdShadeSourceInfoVector UsdShadeConnectableAPI::GetConnectedSources(UsdShadeOutput const& output,
                                                                     SdfPathVector* invalidSourcePaths) {
    return GetConnectedSources(output.GetAttr(), invalidSourcePaths);
}

/* static  */
bool UsdShadeConnectableAPI::GetRawConnectedSourcePaths(UsdAttribute const& shadingAttr, SdfPathVector* sourcePaths) {
    return shadingAttr.GetConnections(sourcePaths);
}

/* static */
bool UsdShadeConnectableAPI::HasConnectedSource(const UsdAttribute& shadingAttr) {
...
/* static */
bool UsdShadeConnectableAPI::IsSourceConnectionFromBaseMaterial(const UsdAttribute& shadingAttr) {
...
/* static */
bool UsdShadeConnectableAPI::DisconnectSource(UsdAttribute const& shadingAttr, UsdAttribute const& sourceAttr) {
    if (sourceAttr) {
...
/* static */
bool UsdShadeConnectableAPI::ClearSources(UsdAttribute const& shadingAttr) {
    return shadingAttr.ClearConnections();
}

UsdShadeOutput UsdShadeConnectableAPI::CreateOutput(const TfToken& name, const SdfValueTypeName& typeName) const {
    return UsdShadeOutput(GetPrim(), name, typeName);
}

UsdShadeOutput UsdShadeConnectableAPI::GetOutput(const TfToken& name) const {
...
UsdShadeInput UsdShadeConnectableAPI::CreateInput(const TfToken& name, const SdfValueTypeName& typeName) const {
    return UsdShadeInput(GetPrim(), name, typeName);
}

UsdShadeInput UsdShadeConnectableAPI::GetInput(const TfToken& name) const {
...
UsdShadeConnectionSourceInfo::UsdShadeConnectionSourceInfo(UsdStagePtr const& stage, SdfPath const& sourcePath) {
    if (!stage) {
        TF_CODING_ERROR("Invalid stage");
        return;
    }

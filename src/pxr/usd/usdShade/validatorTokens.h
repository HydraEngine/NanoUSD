...
#define USD_SHADE_VALIDATION_ERROR_NAME_TOKENS                                                                       \
    ((connectableInNonContainer, "ConnectableInNonContainer"))(                                                      \
            ...
            (invalidMaterialCollection, "InvalidMaterialCollection"))((invalidResourcePath, "InvalidResourcePath"))( \
            (invalidImplSource, "InvalidImplementationSrc"))((missingSourceType, "MissingSourceType"))(              \
            ...
            missingFamilyNameOnGeomSubset, "MissingFamilyNameOnGeomSubset"))((invalidFamilyType, "InvalidFamilyType"))

/// \def USD_SHADE_VALIDATOR_NAME_TOKENS
/// Tokens representing validator names. Note that for plugin provided
/// validators, the names must be prefixed by usdShade:, which is the name of
/// the usdShade plugin.
TF_DECLARE_PUBLIC_TOKENS(UsdShadeValidatorNameTokens, USDSHADE_API, USD_SHADE_VALIDATOR_NAME_TOKENS);
...
/// validator.
TF_DECLARE_PUBLIC_TOKENS(UsdShadeValidatorKeywordTokens, USDSHADE_API, USD_SHADE_VALIDATOR_KEYWORD_TOKENS);

/// \def USD_SHADE_VALIDATION_ERROR_NAME_TOKENS
/// Tokens representing validation error identifier.
TF_DECLARE_PUBLIC_TOKENS(UsdShadeValidationErrorNameTokens, USDSHADE_API, USD_SHADE_VALIDATION_ERROR_NAME_TOKENS);

...
public:
    ...
    USDSHADE_API
    static bool CanConnect(const UsdShadeInput& input, const UsdAttribute& source);

    /// \overload
    USDSHADE_API
    static bool CanConnect(const UsdShadeInput& input, const UsdShadeInput& sourceInput) {
        return CanConnect(input, sourceInput.GetAttr());
    }

    /// \overload
    USDSHADE_API
    static bool CanConnect(const UsdShadeInput& input, const UsdShadeOutput& sourceOutput) {
    ...
    /// \overload
    USDSHADE_API
    static bool CanConnect(const UsdShadeOutput& output, const UsdShadeInput& sourceInput) {
        return CanConnect(output, sourceInput.GetAttr());
    }

    /// \overload
    USDSHADE_API
    static bool CanConnect(const UsdShadeOutput& output, const UsdShadeOutput& sourceOutput) {
    ...
    /// \overload
    USDSHADE_API
    static bool ConnectToSource(UsdShadeInput const& input, SdfPath const& sourcePath) {
        return ConnectToSource(input.GetAttr(), sourcePath);
    }

    /// \overload
    USDSHADE_API
    static bool ConnectToSource(UsdShadeOutput const& output, SdfPath const& sourcePath) {
    ...
    ///
    USDSHADE_API
    static bool ConnectToSource(UsdAttribute const& shadingAttr, UsdShadeInput const& sourceInput);

    /// \overload
    USDSHADE_API
    static bool ConnectToSource(UsdShadeInput const& input, UsdShadeInput const& sourceInput) {
        return ConnectToSource(input.GetAttr(), sourceInput);
    }

    /// \overload
    USDSHADE_API
    static bool ConnectToSource(UsdShadeOutput const& output, UsdShadeInput const& sourceInput) {
    ...
    ///
    USDSHADE_API
    static bool ConnectToSource(UsdAttribute const& shadingAttr, UsdShadeOutput const& sourceOutput);

    /// \overload
    USDSHADE_API
    static bool ConnectToSource(UsdShadeInput const& input, UsdShadeOutput const& sourceOutput) {
        return ConnectToSource(input.GetAttr(), sourceOutput);
    }

    /// \overload
    USDSHADE_API
    static bool ConnectToSource(UsdShadeOutput const& output, UsdShadeOutput const& sourceOutput) {
    ...
    USDSHADE_API
    static UsdShadeSourceInfoVector GetConnectedSources(UsdAttribute const& shadingAttr,
                                                        SdfPathVector* invalidSourcePaths = nullptr);

    /// \overload
    USDSHADE_API
    static UsdShadeSourceInfoVector GetConnectedSources(UsdShadeInput const& input,
                                                        SdfPathVector* invalidSourcePaths = nullptr);

    /// \overload
    USDSHADE_API
    static UsdShadeSourceInfoVector GetConnectedSources(UsdShadeOutput const& output,
                                                        SdfPathVector* invalidSourcePaths = nullptr);
    ...
    /// \overload
    USDSHADE_API
    static bool GetRawConnectedSourcePaths(UsdShadeInput const& input, SdfPathVector* sourcePaths) {
    ...
    /// \overload
    USDSHADE_API
    static bool GetRawConnectedSourcePaths(UsdShadeOutput const& output, SdfPathVector* sourcePaths) {
    ...
    /// \overload
    USDSHADE_API
    static bool HasConnectedSource(const UsdShadeInput& input) { return HasConnectedSource(input.GetAttr()); }

    /// \overload
    USDSHADE_API
    static bool HasConnectedSource(const UsdShadeOutput& output) { return HasConnectedSource(output.GetAttr()); }
    ...
    /// \sa ConnectToSource().
    USDSHADE_API
    static bool DisconnectSource(UsdAttribute const& shadingAttr, UsdAttribute const& sourceAttr = UsdAttribute());
    ...
    /// \overload
    USDSHADE_API
    static bool ClearSources(UsdShadeInput const& input) { return ClearSources(input.GetAttr()); }

    /// \overload
    USDSHADE_API
    static bool ClearSources(UsdShadeOutput const& output) { return ClearSources(output.GetAttr()); }

    /// \deprecated This is the older version that only referenced a single
    /// source. Please use ClearSources instead.
    USDSHADE_API
    static bool ClearSource(UsdAttribute const& shadingAttr) { return ClearSources(shadingAttr); }

    /// \deprecated
    /// \overload
    USDSHADE_API
    static bool ClearSource(UsdShadeInput const& input) { return ClearSources(input.GetAttr()); }

    /// \deprecated
    /// \overload
    USDSHADE_API
    static bool ClearSource(UsdShadeOutput const& output) { return ClearSources(output.GetAttr()); }
...
struct UsdShadeConnectionSourceInfo {
    ...
    explicit UsdShadeConnectionSourceInfo(UsdShadeConnectableAPI const& source_,
    ...
    USDSHADE_API
    explicit UsdShadeConnectionSourceInfo(UsdStagePtr const& stage, SdfPath const& sourcePath);
    ...
    bool operator!=(const UsdShadeConnectionSourceInfo& other) const { return !(*this == other); }
};

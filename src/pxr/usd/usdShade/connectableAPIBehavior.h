...
public:
    ...
    UsdShadeConnectableAPIBehavior(const bool isContainer, const bool requiresEncapsulation)
        : _isContainer(isContainer), _requiresEncapsulation(requiresEncapsulation) {}
    ...
    ///
    USDSHADE_API
    virtual bool CanConnectInputToSource(const UsdShadeInput&, const UsdAttribute&, std::string* reason) const;
    ...
    ///
    USDSHADE_API
    virtual bool CanConnectOutputToSource(const UsdShadeOutput&, const UsdAttribute&, std::string* reason) const;

...
private:
    bool _ReadFromChars(SdfLayer* layer, const char* str, size_t size, bool metadataOnly, std::string* outErr) const;

    virtual bool _IsStreamingLayer(const SdfLayer& layer) const { return false; }
};

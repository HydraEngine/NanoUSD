...
/* static */
bool UsdUINodeGraphNodeAPI::CanApply(const UsdPrim& prim, std::string* whyNot) {
...
UsdAttribute UsdUINodeGraphNodeAPI::CreatePosAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdUITokens->uiNodegraphNodePos, SdfValueTypeNames->Float2,
...
UsdAttribute UsdUINodeGraphNodeAPI::CreateStackingOrderAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdUITokens->uiNodegraphNodeStackingOrder, SdfValueTypeNames->Int,
                                      /* custom = */ false, SdfVariabilityUniform, defaultValue, writeSparsely);
}
...
UsdAttribute UsdUINodeGraphNodeAPI::CreateDisplayColorAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdUITokens->uiNodegraphNodeDisplayColor, SdfValueTypeNames->Color3f,
                                      /* custom = */ false, SdfVariabilityUniform, defaultValue, writeSparsely);
}
...
UsdAttribute UsdUINodeGraphNodeAPI::CreateIconAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdUITokens->uiNodegraphNodeIcon, SdfValueTypeNames->Asset,
                                      /* custom = */ false, SdfVariabilityUniform, defaultValue, writeSparsely);
}
...
UsdAttribute UsdUINodeGraphNodeAPI::CreateExpansionStateAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdUITokens->uiNodegraphNodeExpansionState, SdfValueTypeNames->Token,
                                      /* custom = */ false, SdfVariabilityUniform, defaultValue, writeSparsely);
}
...
UsdAttribute UsdUINodeGraphNodeAPI::CreateSizeAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdUITokens->uiNodegraphNodeSize, SdfValueTypeNames->Float2,
                                      /* custom = */ false, SdfVariabilityUniform, defaultValue, writeSparsely);
}

UsdAttribute UsdUINodeGraphNodeAPI::GetDocURIAttr() const {
    return GetPrim().GetAttribute(UsdUITokens->uiNodegraphNodeDocURI);
}

UsdAttribute UsdUINodeGraphNodeAPI::CreateDocURIAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdUITokens->uiNodegraphNodeDocURI, SdfValueTypeNames->String,
                                      /* custom = */ false, SdfVariabilityUniform, defaultValue, writeSparsely);
}

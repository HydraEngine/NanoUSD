...
UsdUITokensType::UsdUITokensType()
    : closed("closed", TfToken::Immortal),
      ...
      allTokens({closed, minimized, open, uiDescription, uiDisplayGroup, uiDisplayName, uiNodegraphNodeDisplayColor,
                 uiNodegraphNodeDocURI, uiNodegraphNodeExpansionState, uiNodegraphNodeIcon, uiNodegraphNodePos,
                 uiNodegraphNodeSize, uiNodegraphNodeStackingOrder, Backdrop, NodeGraphNodeAPI, SceneGraphPrimAPI}) {}

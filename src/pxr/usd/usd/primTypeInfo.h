...
public:
    ...
    const TfTokenVector& GetAppliedAPISchemas() const { return _typeId.appliedAPISchemas; }
    ...
    bool operator!=(const UsdPrimTypeInfo& other) const { return !(*this == other); }
...
private:
    ...
    struct _TypeId {
        ...
        // Is empty type
        bool IsEmpty() const { return primTypeName.IsEmpty() && mappedTypeName.IsEmpty() && appliedAPISchemas.empty(); }

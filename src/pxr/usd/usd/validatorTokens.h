...
#define USD_VALIDATOR_NAME_TOKENS \
    ((compositionErrorTest, "usd:CompositionErrorTest"))((stageMetadataChecker, "usd:StageMetadataChecker"))

#define USD_VALIDATOR_KEYWORD_TOKENS (UsdCoreValidators)

#define USD_VALIDATION_ERROR_NAME_TOKENS \
    ((compositionError, "CompositionError"))((missingDefaultPrim, "MissingDefaultPrim"))

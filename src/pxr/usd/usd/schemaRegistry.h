...
public:
    ...
    USD_API
    static UsdSchemaRegistry& GetInstance() { return TfSingleton<UsdSchemaRegistry>::GetInstance(); }
    ...
    USD_API
    static TfToken MakeSchemaIdentifierForFamilyAndVersion(const TfToken& schemaFamily, UsdSchemaVersion schemaVersion);
    ...
    USD_API
    static bool IsAllowedSchemaFamily(const TfToken& schemaFamily);
    ...
    /// family and version.
    USD_API
    static bool IsAllowedSchemaIdentifier(const TfToken& schemaIdentifier);
    ...
    /// schema type exists.
    USD_API
    static const SchemaInfo* FindSchemaInfo(const TfType& schemaType);
    ...
    USD_API
    static const SchemaInfo* FindSchemaInfo(const TfToken& schemaIdentifier);
    ...
    USD_API
    static const SchemaInfo* FindSchemaInfo(const TfToken& schemaFamily, UsdSchemaVersion schemaVersion);
    ...
    USD_API
    static const std::vector<const SchemaInfo*>& FindSchemaInfosInFamily(const TfToken& schemaFamily);
    ...
    USD_API
    static void CollectAddtionalAutoApplyAPISchemasFromPlugins(TokenToTokenVectorMap* autoApplyAPISchemas);
    ...
    ///
    USD_API
    static TfToken MakeMultipleApplyNameTemplate(const std::string& namespacePrefix, const std::string& baseName);
    ...
    ///
    USD_API
    static TfToken MakeMultipleApplyNameInstance(const std::string& nameTemplate, const std::string& instanceName);
    ...
    ///
    USD_API
    static bool IsMultipleApplyNameTemplate(const std::string& nameTemplate);
    ...
    const UsdPrimDefinition* GetEmptyPrimDefinition() const { return _emptyPrimDefinition; }
    ...
    /// provided types.
    USD_API
    std::unique_ptr<UsdPrimDefinition> BuildComposedPrimDefinition(const TfToken& primType,
    ...
    const VtDictionary& GetFallbackPrimTypes() const { return _fallbackPrimTypes; }
...
private:
    ...
    using _FamilyAndInstanceToVersionMap = std::unordered_map<std::pair<TfToken, TfToken>, UsdSchemaVersion, TfHash>;

    void _ComposeAPISchemasIntoPrimDefinition(UsdPrimDefinition* primDef,
    ...
    std::unordered_map<TfToken, const std::unique_ptr<UsdPrimDefinition>, TfHash> _concreteTypedPrimDefinitions;

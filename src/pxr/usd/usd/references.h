...
///
/// \subsection Usd_Failing_References Reasons why adding a reference may fail, why adding a reference may succeed but
/// still generate errors, and what it all means
///

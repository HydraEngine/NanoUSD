...
UsdValidator::UsdValidator(const UsdValidatorMetadata& metadata, const UsdValidateLayerTaskFn& validateLayerTaskFn)
    : _metadata(metadata), _validateTaskFn(validateLayerTaskFn) {}

UsdValidator::UsdValidator(const UsdValidatorMetadata& metadata, const UsdValidateStageTaskFn& validateStageTaskFn)
    : _metadata(metadata), _validateTaskFn(validateStageTaskFn) {}

UsdValidator::UsdValidator(const UsdValidatorMetadata& metadata, const UsdValidatePrimTaskFn& validatePrimTaskFn)

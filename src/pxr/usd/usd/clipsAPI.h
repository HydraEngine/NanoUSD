...
public:
    ...
    /// clipAssetPaths.
    USD_API
    VtArray<SdfAssetPath> ComputeClipAssetPaths(const std::string& clipSet) const;
    ...
    USD_API
    bool GetClipPrimPath(std::string* primPath, const std::string& clipSet) const;
    /// \overload
    /// This function operates on the default clip set.
    /// \sa \ref UsdClipsAPISetNames
    USD_API
    ...
    /// \sa GetClipPrimPath()
    USD_API
    bool SetClipPrimPath(const std::string& primPath, const std::string& clipSet);
    /// \overload
    /// This function operates on the default clip set.
    /// \sa \ref UsdClipsAPISetNames
    USD_API
    ...
    USD_API
    bool GetClipTimes(VtVec2dArray* clipTimes, const std::string& clipSet) const;
    /// \overload
    /// This function operates on the default clip set.
    /// \sa \ref UsdClipsAPISetNames
    USD_API
    ...
    /// \sa GetClipTimes()
    USD_API
    bool SetClipTimes(const VtVec2dArray& clipTimes, const std::string& clipSet);
    /// \overload
    /// This function operates on the default clip set.
    /// \sa \ref UsdClipsAPISetNames
    USD_API
...
/// \hideinitializer
#define USDCLIPS_SET_NAMES ((default_, "default"))

...
public:
    ...
    USD_API
    explicit UsdValidationContext(const TfTokenVector& keywords, bool includeAllAncestors = true);
    ...
    /// for any schema type validators found, default is `true`.
    USD_API
    explicit UsdValidationContext(const PlugPluginPtrVector& plugins, bool includeAllAncestors = true);
    ...
    /// for any schema type validators found, default is `true`.
    USD_API
    explicit UsdValidationContext(const UsdValidatorMetadataVector& metadata, bool includeAllAncestors = true);
    ...
    USD_API
    explicit UsdValidationContext(const std::vector<const UsdValidator*>& validators);
    ...
    USD_API
    explicit UsdValidationContext(const std::vector<const UsdValidatorSuite*>& suites);
...
private:
    ...
    void _InitializeFromValidatorMetadata(const UsdValidatorMetadataVector& metadata, bool includeAllAncestors);
    ...
    void _DistributeValidators(const std::vector<const UsdValidator*>& validators);
    ...
    using _SchemaTypeValidatorPair = std::pair<TfToken, std::vector<const UsdValidator*>>;
    using _SchemaTypeValidatorPairVector = std::vector<_SchemaTypeValidatorPair>;

...
#define USD_USDZ_FILE_FORMAT_TOKENS ((Id, "usdz"))((Version, "1.0"))((Target, "usd"))
...
public:
    ...
    USD_API
    virtual std::string GetPackageRootLayerPath(const std::string& resolvedPath) const override;

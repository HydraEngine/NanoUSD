...
UsdAttribute UsdRenderSettings::CreateIncludedPurposesAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdRenderTokens->includedPurposes, SdfValueTypeNames->TokenArray,
...
UsdAttribute UsdRenderSettings::CreateMaterialBindingPurposesAttr(VtValue const& defaultValue,
    ...
    return UsdSchemaBase::_CreateAttr(UsdRenderTokens->materialBindingPurposes, SdfValueTypeNames->TokenArray,
                                      /* custom = */ false, SdfVariabilityUniform, defaultValue, writeSparsely);
}
...
UsdAttribute UsdRenderSettings::CreateRenderingColorSpaceAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdRenderTokens->renderingColorSpace, SdfValueTypeNames->Token,
                                      /* custom = */ false, SdfVariabilityUniform, defaultValue, writeSparsely);
}
...
const TfTokenVector& UsdRenderSettings::GetSchemaAttributeNames(bool includeInherited) {
    ...
    static TfTokenVector allNames =
            _ConcatenateAttributeNames(UsdRenderSettingsBase::GetSchemaAttributeNames(true), localNames);

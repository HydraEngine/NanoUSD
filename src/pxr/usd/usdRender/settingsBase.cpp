...
UsdAttribute UsdRenderSettingsBase::CreateResolutionAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdRenderTokens->resolution, SdfValueTypeNames->Int2,
...
UsdAttribute UsdRenderSettingsBase::CreatePixelAspectRatioAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdRenderTokens->pixelAspectRatio, SdfValueTypeNames->Float,
                                      /* custom = */ false, SdfVariabilityUniform, defaultValue, writeSparsely);
}
...
UsdAttribute UsdRenderSettingsBase::CreateAspectRatioConformPolicyAttr(VtValue const& defaultValue,
    ...
    return UsdSchemaBase::_CreateAttr(UsdRenderTokens->aspectRatioConformPolicy, SdfValueTypeNames->Token,
                                      /* custom = */ false, SdfVariabilityUniform, defaultValue, writeSparsely);
}
...
UsdAttribute UsdRenderSettingsBase::CreateDataWindowNDCAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdRenderTokens->dataWindowNDC, SdfValueTypeNames->Float4,
                                      /* custom = */ false, SdfVariabilityUniform, defaultValue, writeSparsely);
}
...
UsdAttribute UsdRenderSettingsBase::CreateInstantaneousShutterAttr(VtValue const& defaultValue,
                                                                   bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdRenderTokens->instantaneousShutter, SdfValueTypeNames->Bool,
                                      /* custom = */ false, SdfVariabilityUniform, defaultValue, writeSparsely);
}
...
UsdAttribute UsdRenderSettingsBase::CreateDisableMotionBlurAttr(VtValue const& defaultValue, bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdRenderTokens->disableMotionBlur, SdfValueTypeNames->Bool,
                                      /* custom = */ false, SdfVariabilityUniform, defaultValue, writeSparsely);
}

UsdAttribute UsdRenderSettingsBase::GetDisableDepthOfFieldAttr() const {
    return GetPrim().GetAttribute(UsdRenderTokens->disableDepthOfField);
}

UsdAttribute UsdRenderSettingsBase::CreateDisableDepthOfFieldAttr(VtValue const& defaultValue,
                                                                  bool writeSparsely) const {
    return UsdSchemaBase::_CreateAttr(UsdRenderTokens->disableDepthOfField, SdfValueTypeNames->Bool,
                                      /* custom = */ false, SdfVariabilityUniform, defaultValue, writeSparsely);
}

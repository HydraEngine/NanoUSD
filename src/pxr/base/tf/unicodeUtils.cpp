...
std::ostream& operator<<(std::ostream& stream, const TfUtf8CodePoint codePoint) {
...
uint32_t TfUtf8CodePointIterator::_GetCodePoint() const {
    ...
    if (encodingLength == 2) {
        ...
        if (byte1 == static_cast<unsigned char>('\xe0')) {
            ...
            if (byte2 < static_cast<unsigned char>('\xa0') || byte2 > static_cast<unsigned char>('\xbf') ||
                ...
                return TfUtf8InvalidCodePoint.AsUInt32();
                   ...
                   byte1 == static_cast<unsigned char>('\xee') || byte1 == static_cast<unsigned char>('\xef')) {
        ...
        return ((byte1 & 0x7) << 18) + ((byte2 & 0x3f) << 12) + ((byte3 & 0x3f) << 6) + (byte4 & 0x3f);
    }
    return TfUtf8InvalidCodePoint.AsUInt32();
}

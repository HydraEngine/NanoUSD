...
void TF_PP_CAT(init_module_, MFB_PACKAGE_NAME)() {
    Tf_PyInitWrapModule(WrapModule, TF_PP_STRINGIZE(MFB_PACKAGE_MODULE), TF_PP_STRINGIZE(MFB_ALT_PACKAGE_NAME),
                        "Wrap " TF_PP_STRINGIZE(MFB_ALT_PACKAGE_NAME), TF_PP_STRINGIZE(MFB_PACKAGE_NAME));
}
...
//
extern "C" ARCH_EXPORT PyObject* TF_PP_CAT(PyInit__, MFB_PACKAGE_NAME)() {
    ...
    return pxr_boost::python::detail::init_module(moduledef, TF_PP_CAT(init_module_, MFB_PACKAGE_NAME));
}
...
//
extern "C" ARCH_EXPORT PyObject* TF_PP_CAT(PyInit_lib, MFB_PACKAGE_NAME)() {
    static struct PyModuleDef moduledef = {
            PyModuleDef_HEAD_INIT,

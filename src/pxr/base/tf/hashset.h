...
public:
    ...
    friend bool operator==(const TfHashSet<Key2, HashFn2, EqualKey2, Alloc2>&,
...
public:
    ...
    template <class Key2, class HashFn2, class EqualKey2, class Alloc2>
    friend bool operator==(const TfHashMultiSet<Key2, HashFn2, EqualKey2, Alloc2>&,
...
template <class Key, class HashFn, class EqualKey, class Alloc>
inline bool operator==(const TfHashSet<Key, HashFn, EqualKey, Alloc>& lhs,
...
template <class Key, class HashFn, class EqualKey, class Alloc>
inline void swap(TfHashMultiSet<Key, HashFn, EqualKey, Alloc>& lhs, TfHashMultiSet<Key, HashFn, EqualKey, Alloc>& rhs) {
    lhs.swap(rhs);
}

template <class Key, class HashFn, class EqualKey, class Alloc>
inline bool operator==(const TfHashMultiSet<Key, HashFn, EqualKey, Alloc>& lhs,

...
void Tf_PostErrorHelper(const TfCallContext& context, const TfEnum& code, const std::string& msg) {
    TfDiagnosticMgr::ErrorHelper(context, code, TfEnum::GetName(code).c_str()).Post(msg);
}

void Tf_PostErrorHelper(const TfCallContext& context, TfDiagnosticType code, const std::string& msg) {
    Tf_PostErrorHelper(context, TfEnum(code), msg);
}

void Tf_PostErrorHelper(const TfCallContext& context, const TfEnum& code, const char* fmt, ...) {
    va_list ap;
    va_start(ap, fmt);
...
void Tf_PostErrorHelper(const TfCallContext& context, TfDiagnosticType code, const char* fmt, ...) {
    va_list ap;
    va_start(ap, fmt);
    Tf_PostErrorHelper(context, code, TfVStringPrintf(fmt, ap));
    va_end(ap);
...
void Tf_PostQuietlyErrorHelper(const TfCallContext& context, const TfEnum& code, const std::string& msg) {
    TfDiagnosticMgr::ErrorHelper(context, code, TfEnum::GetName(code).c_str()).PostQuietly(msg);
}

void Tf_PostQuietlyErrorHelper(const TfCallContext& context,
                               const TfEnum& code,
...
void Tf_PostQuietlyErrorHelper(const TfCallContext& context, const TfEnum& code, const char* fmt, ...) {
    va_list ap;
    va_start(ap, fmt);
...
void Tf_PostQuietlyErrorHelper(
        const TfCallContext& context, const TfEnum& code, const TfDiagnosticInfo& info, const char* fmt, ...) {
    va_list ap;
    va_start(ap, fmt);
...
void Tf_PostErrorHelper(const TfCallContext& context,
                        const TfDiagnosticInfo& info,
                        const TfEnum& code,
                        const std::string& msg) {
...
void Tf_PostErrorHelper(
        const TfCallContext& context, const TfDiagnosticInfo& info, const TfEnum& code, const char* fmt, ...) {
    va_list ap;
    va_start(ap, fmt);
    Tf_PostErrorHelper(context, info, code, TfVStringPrintf(fmt, ap));
    va_end(ap);
}
...
void Tf_PostWarningHelper(const TfCallContext& context, const TfEnum& code, const std::string& msg) {
...
void Tf_PostWarningHelper(const TfCallContext& context, const TfEnum& code, const char* fmt, ...) {
    va_list ap;
    va_start(ap, fmt);
...
void Tf_PostStatusHelper(const TfCallContext& context, const TfEnum& code, const std::string& msg) {
    TfDiagnosticMgr::StatusHelper(context, code, TfEnum::GetName(code).c_str()).Post(msg);
}

void Tf_PostStatusHelper(const TfCallContext& context, const TfEnum& code, const char* fmt, ...) {
    va_list ap;
    va_start(ap, fmt);
...
void Tf_DiagnosticHelper::IssueError(char const* fmt, ...) const {
    va_list ap;
    va_start(ap, fmt);
...
void Tf_DiagnosticHelper::IssueFatalError(char const* fmt, ...) const {
    va_list ap;
    va_start(ap, fmt);
    TfDiagnosticMgr::FatalHelper(GetContext(), GetType()).Post(TfVStringPrintf(fmt, ap));
    va_end(ap);
}

void Tf_DiagnosticHelper::IssueWarning(char const* fmt, ...) const {
    va_list ap;
    va_start(ap, fmt);
...
void Tf_DiagnosticHelper::IssueStatus(char const* fmt, ...) const {
    va_list ap;
    va_start(ap, fmt);
...
void Tf_DiagnosticHelper::IssueError(std::string const& msg) const {
    TfDiagnosticMgr::ErrorHelper(GetContext(), GetType(), TfEnum::GetName(TfEnum(GetType())).c_str()).Post(msg);
}
...
void Tf_DiagnosticHelper::IssueWarning(std::string const& msg) const {
    TfDiagnosticMgr::WarningHelper(GetContext(), GetType(), TfEnum::GetName(TfEnum(GetType())).c_str()).Post(msg);
}

void Tf_DiagnosticHelper::IssueStatus(std::string const& msg) const {
    TfDiagnosticMgr::StatusHelper(GetContext(), GetType(), TfEnum::GetName(TfEnum(GetType())).c_str()).Post(msg);
}
...
void Tf_DiagnosticLiteHelper::IssueError(char const* fmt, ...) const {
    va_list ap;
    va_start(ap, fmt);
...
void Tf_DiagnosticLiteHelper::IssueFatalError(char const* fmt, ...) const {
    va_list ap;
    va_start(ap, fmt);
    TfDiagnosticMgr::FatalHelper(_context, _type).Post(TfVStringPrintf(fmt, ap));
    va_end(ap);
}

void Tf_DiagnosticLiteHelper::IssueWarning(char const* fmt, ...) const {
    va_list ap;
    va_start(ap, fmt);
...
void Tf_DiagnosticLiteHelper::IssueStatus(char const* fmt, ...) const {
    va_list ap;
    va_start(ap, fmt);

...
void Tf_RefPtr_UniqueChangedCounter ::_AddRefMaybeLocked(TfRefBase const* refBase, int prevCount) {
...
bool Tf_RefPtr_UniqueChangedCounter ::_RemoveRefMaybeLocked(TfRefBase const* refBase, int prevCount) {
...
bool Tf_RefPtr_UniqueChangedCounter ::AddRefIfNonzero(TfRefBase const* refBase) {

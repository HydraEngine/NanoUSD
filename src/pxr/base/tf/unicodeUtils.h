...
public:
    ...
    constexpr explicit TfUtf8CodePoint(uint32_t value)
        : _value(((value <= MaximumValue) && ((value < SurrogateRange.first) || (value > SurrogateRange.second)))
                         ? value
                         : ReplacementValue) {}
...
constexpr TfUtf8CodePoint TfUtf8InvalidCodePoint{TfUtf8CodePoint::ReplacementValue};
...
constexpr TfUtf8CodePoint TfUtf8CodePointFromAscii(const char value) {
    return static_cast<unsigned char>(value) < 128 ? TfUtf8CodePoint(static_cast<unsigned char>(value))
...
public:
    ...
    value_type operator*() const { return TfUtf8CodePoint{_GetCodePoint()}; }

    /// Retrieves the wrapped string iterator.
    std::string_view::const_iterator GetBase() const { return this->_it; }
    ...
    bool operator==(const TfUtf8CodePointIterator& rhs) const { return (this->_it == rhs._it); }
    ...
    TfUtf8CodePointIterator& operator++() {
        ...
        auto isContinuation = [](const char c) {
            ...
            return (uc >= static_cast<unsigned char>('\x80')) && (uc < static_cast<unsigned char>('\xc0'));
        };
    ...
    friend bool operator==(const TfUtf8CodePointIterator& lhs, PastTheEndSentinel) { return lhs._IsPastTheEnd(); }

    friend bool operator==(PastTheEndSentinel lhs, const TfUtf8CodePointIterator& rhs) { return rhs == lhs; }

    friend bool operator!=(const TfUtf8CodePointIterator& lhs, PastTheEndSentinel rhs) { return !(lhs == rhs); }
    friend bool operator!=(PastTheEndSentinel lhs, const TfUtf8CodePointIterator& rhs) { return !(lhs == rhs); }
...
private:
    ...
    // dereferenced.
    bool _IsPastTheEnd() const { return _it >= _end; }
...
public:
    ...
    inline const_iterator begin() const { return const_iterator{std::cbegin(_view), std::cend(_view)}; }

    /// The sentinel will compare as equal to any iterator at the end
    /// of the underlying `string_view`
    TfUtf8CodePointIterator::PastTheEndSentinel end() const { return TfUtf8CodePointIterator::PastTheEndSentinel{}; }

    inline const_iterator cbegin() const { return begin(); }

    /// The sentinel will compare as equal to any iterator at the end
    /// of the underlying `string_view`
    TfUtf8CodePointIterator::PastTheEndSentinel cend() const { return end(); }
    ...
    inline const_iterator EndAsIterator() const { return const_iterator(std::cend(_view), std::cend(_view)); }

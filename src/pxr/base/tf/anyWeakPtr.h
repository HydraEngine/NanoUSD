...
public:
    ...
    size_t GetHash() const { return reinterpret_cast<uintptr_t>(GetUniqueIdentifier()) >> 3; }
...
private:
    ...
    friend pxr_boost::python::api::object Tf_GetPythonObjectFromAnyWeakPtr(This const& self);
    ...
    _PointerHolderBase* _Get() const { return (_PointerHolderBase*)(&_ptrStorage); }

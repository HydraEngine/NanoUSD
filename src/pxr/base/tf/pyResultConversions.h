...
struct Tf_PySequenceToListConverter {
    ...
    PyObject* operator()(T seq) const { return pxr_boost::python::incref(TfPyCopySequenceToList(seq).ptr()); }
...
struct Tf_PySequenceToSetConverter {
    typedef std::remove_reference_t<T> SeqType;
    bool convertible() const { return true; }
    PyObject* operator()(T seq) const { return pxr_boost::python::incref(TfPyCopySequenceToSet(seq).ptr()); }
...
struct Tf_PyMapToDictionaryConverter {
    ...
    bool convertible() const { return true; }
    PyObject* operator()(T seq) const { return pxr_boost::python::incref(TfPyCopyMapToDictionary(seq).ptr()); }
...
struct Tf_PySequenceToTupleConverter {
    typedef std::remove_reference_t<T> SeqType;
    bool convertible() const { return true; }
    PyObject* operator()(T seq) const { return pxr_boost::python::incref(TfPyCopySequenceToTuple(seq).ptr()); }

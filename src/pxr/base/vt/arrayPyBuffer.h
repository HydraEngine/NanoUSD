...
template <class T>
std::optional<VtArray<T>> VtArrayFromPyBuffer(TfPyObjWrapper const& obj, std::string* err = nullptr);
...
#define VT_ARRAY_PYBUFFER_TYPES                                                                                 \
    ...
    ((GfQuath, Quath))((GfQuatf, Quatf))((GfQuatd, Quatd))((GfDualQuath, DualQuath))((GfDualQuatf, DualQuatf))( \

...
#define ARCH_PRAGMA_UNUSED_FUNCTION _Pragma("clang diagnostic ignored \"-Wunused-function\"")

#define ARCH_PRAGMA_UNUSED_PRIVATE_FIELD _Pragma("clang diagnostic ignored \"-Wunused-private-field\"")
...
#define ARCH_PRAGMA_MACRO_REDEFINITION __pragma(warning(disable : 4005))

#define ARCH_PRAGMA_UNUSED_FUNCTION __pragma(warning(disable : 4505))

#define ARCH_PRAGMA_QUALIFIER_HAS_NO_MEANING __pragma(warning(disable : 4180))

#define ARCH_PRAGMA_ZERO_SIZED_STRUCT __pragma(warning(disable : 4200))

#define ARCH_PRAGMA_NEEDS_EXPORT_INTERFACE __pragma(warning(disable : 4251))

#define ARCH_PRAGMA_CONVERSION_FROM_SIZET __pragma(warning(disable : 4267))

#define ARCH_PRAGMA_MAY_NOT_BE_ALIGNED __pragma(warning(disable : 4316))

#define ARCH_PRAGMA_SHIFT_TO_64_BITS __pragma(warning(disable : 4334))

#define ARCH_PRAGMA_DESTRUCTOR_IMPLICIT_DEFINE __pragma(warning(disable : 4624))

#define ARCH_PRAGMA_DEPRECATED_POSIX_NAME __pragma(warning(disable : 4996))

#define ARCH_PRAGMA_FORCING_TO_BOOL __pragma(warning(disable : 4800))

#define ARCH_PRAGMA_UNSAFE_USE_OF_BOOL __pragma(warning(disable : 4804))

#define ARCH_PRAGMA_UNARY_MINUS_ON_UNSIGNED __pragma(warning(disable : 4146))

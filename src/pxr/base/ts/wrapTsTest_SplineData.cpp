...
static This::Knot* _ConstructKnot(const double timeIn,
...
static std::string _KnotRepr(const This::Knot& kf) {
    ...
    result << "Ts.TsTest_SplineData.Knot("
           ...
           << ", preSlope = " << _HexFloatRepr(kf.preSlope) << ", postSlope = " << _HexFloatRepr(kf.postSlope)
           << ", preLen = " << _HexFloatRepr(kf.preLen) << ", postLen = " << _HexFloatRepr(kf.postLen)
           << ", preAuto = " << (kf.preAuto ? "True" : "False") << ", postAuto = " << (kf.postAuto ? "True" : "False");
...
static This::InnerLoopParams* _ConstructInnerLoopParams(const bool enabledIn,
...
static std::string _InnerLoopParamsRepr(const This::InnerLoopParams& lp) {
    ...
    result << "Ts.TsTest_SplineData.InnerLoopParams("
           << "enabled = " << (lp.enabled ? "True" : "False") << ", protoStart = " << _HexFloatRepr(lp.protoStart)
           << ", protoEnd = " << _HexFloatRepr(lp.protoEnd) << ", numPreLoops = " << lp.numPreLoops
           << ", numPostLoops = " << lp.numPostLoops << ", valueOffset = " << _HexFloatRepr(lp.valueOffset) << ")";
...
static void _SetKnots(This& data, const object& knots) {
...
static std::string _SplineDataRepr(const This& data) {
    ...
    if (!knots.empty()) {
        ...
        for (const This::Knot& kf : knots) kfStrs.push_back(_KnotRepr(kf));
...
static std::string _SplineDataDebugDescription(const This& data) {
...
void wrapTsTest_SplineData() {
    ...
    class_<This::Knot>("Knot", no_init)
            ...
            .def("__init__",
                 make_constructor(&_ConstructKnot, default_call_policies(),
                                  (arg("time") = 0.0, arg("nextSegInterpMethod") = This::InterpHeld, arg("value") = 0.0,
                                   arg("preValue") = object(), arg("preSlope") = object(), arg("postSlope") = object(),
                                   arg("preLen") = object(), arg("postLen") = object(), arg("preAuto") = object(),
                                   arg("postAuto") = object())))
    ...
    class_<This::InnerLoopParams>("InnerLoopParams", no_init)
            ...
            .def("__init__", make_constructor(&_ConstructInnerLoopParams, default_call_policies(),
                                              (arg("enabled") = false, arg("protoStart") = object(),
                                               arg("protoEnd") = object(), arg("numPreLoops") = object(),
                                               arg("numPostLoops") = object(), arg("valueOffset") = object())))
    ...
    class_<This::Extrapolation>("Extrapolation", no_init)
            ...
            .def("__init__", make_constructor(&_ConstructExtrapolation, default_call_policies(),
                                              (arg("method") = This::ExtrapHeld, arg("slope") = 0.0,
    ...
    classObj
            ...
            .def(init<const This&>())
            .def("__init__", make_constructor(&_ConstructSplineData, default_call_policies(),
                                              (arg("isHermite") = false, arg("knots") = object(),
                                               arg("preExtrapolation") = object(), arg("postExtrapolation") = object(),
            ...
            .def("SetKnots", &_SetKnots, (arg("knots")))
            ...
            .def("GetPreExtrapolation", &This::GetPreExtrapolation, return_value_policy<return_by_value>())

            .def("GetPostExtrapolation", &This::GetPostExtrapolation, return_value_policy<return_by_value>())
            ...
            .def("GetDebugDescription", &This::GetDebugDescription, (arg("precision") = 6))

...
bool TsConvertToStandardTangent(const TsTime widthIn,
    ...
    static_assert((std::is_same_v<NonVolatileT, double> || std::is_same_v<NonVolatileT, float> ||
                   std::is_same_v<NonVolatileT, GfHalf>),
                  "Can only use double, float, or GfHalf values in"
                  " TsConvertToStandardTangent.");

    return Ts_ConvertToStandardHelper(widthIn, slopeOrHeightIn, convertHeightToSlope, divideValuesByThree, negateHeight,
                                      widthOut, slopeOut);
}

template <typename T>
bool TsConvertFromStandardTangent(const TsTime widthIn,
                                  const T slopeIn,
                                  bool convertSlopeToHeight,
                                  bool multiplyValuesByThree,
                                  bool negateHeight,
    ...
    return Ts_ConvertFromStandardHelper(widthIn, slopeIn, convertSlopeToHeight, multiplyValuesByThree, negateHeight,

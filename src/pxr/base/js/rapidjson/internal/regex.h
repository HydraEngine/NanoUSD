        ...
        */
        ...
        private:
            ...
            bool AddState(Stack<Allocator>& l, SizeType index) {
                ...
                return s.out == kRegexInvalidState;  // by using PushUnsafe() above, we can ensure s is not validated
                                                     // due to reallocation.
            }
            ...
            bool MatchRange(SizeType rangeIndex, unsigned codepoint) const {
                ...
                while (rangeIndex != kRegexInvalidRange) {
                    ...
                    if (codepoint >= (r.start & ~RegexType::kRangeNegationFlag) && codepoint <= r.end) return yes;
                    rangeIndex = r.next;
                }
                return !yes;
            }

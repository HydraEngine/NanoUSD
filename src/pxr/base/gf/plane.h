...
public:
    ...
    GfPlane(const GfVec3d& normal, double distanceToOrigin) { Set(normal, distanceToOrigin); }
    ...
    /// collinear.
    GfPlane(const GfVec3d& p0, const GfVec3d& p1, const GfVec3d& p2) { Set(p0, p1, p2); }
    ...
    /// collinear.
    GF_API
    void Set(const GfVec3d& p0, const GfVec3d& p1, const GfVec3d& p2);
    ...
    bool operator==(const GfPlane& p) const { return (_normal == p._normal && _distance == p._distance); }
    ...
    GfVec3d Project(const GfVec3d& p) const { return p - GetDistance(p) * _normal; }
    ...
    /// half space.
    bool IntersectsPositiveHalfSpace(const GfVec3d& pt) const { return GetDistance(pt) >= 0.0; }

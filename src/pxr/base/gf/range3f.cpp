...
GfRange3f::GfRange3f(class GfRange3d const& other) : _min(GfVec3f(other.GetMin())), _max(GfVec3f(other.GetMax())) {}
...
GfVec3f GfRange3f::GetCorner(size_t i) const {
    ...
    return GfVec3f((i & 1 ? _max : _min)[0], (i & 2 ? _max : _min)[1], (i & 4 ? _max : _min)[2]);
}
...
GfRange3f GfRange3f::GetOctant(size_t i) const {
    ...
    return GfRange3f(GfVec3f(GfMin(a[0], b[0]), GfMin(a[1], b[1]), GfMin(a[2], b[2])),

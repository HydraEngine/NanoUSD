...
#define GF_COLORSPACE_NAME_TOKENS                                                                                      \
    ((CIEXYZ, "lin_ciexyzd65_scene"))((Data, "data"))((Raw, "raw"))((Unknown, "unknown"))(                             \
            (LinearAdobeRGB, "lin_adobergb_scene"))((LinearAP0, "lin_ap0_scene"))((LinearAP1, "lin_ap1_scene"))(       \
            (LinearDisplayP3, "lin_displayp3_scene"))((LinearRec2020, "lin_rec2020_scene"))(                           \
            (LinearRec709, "lin_rec709_scene"))((G18Rec709, "g18_rec709_scene"))((G22AdobeRGB, "g22_adobergb_scene"))( \
            (G22AP1, "g22_ap1_scene"))((G22Rec709, "g22_rec709_scene"))((SRGBP3D65, "srgb_p3d65_scene"))(              \
            (SRGBRec709, "srgb_rec709_scene"))((SRGBAP1, "srgb_ap1_scene"))
...
public:
    ...
    /// \param linearBias The linear bias of the log section.
    GF_API
    explicit GfColorSpace(const TfToken& name, const GfMatrix3f& rgbToXYZ, float gamma, float linearBias);
    ...
    GF_API
    std::tuple<GfVec2f, GfVec2f, GfVec2f, GfVec2f> GetPrimariesAndWhitePoint() const;

...
public:
    ...
    GfVec4f GetRow(int i) const { return GfVec4f(_mtx[i][0], _mtx[i][1], _mtx[i][2], _mtx[i][3]); }

    /// Gets a column of the matrix as a Vec4.
    GfVec4f GetColumn(int i) const { return GfVec4f(_mtx[0][i], _mtx[1][i], _mtx[2][i], _mtx[3][i]); }
    ...
    GfMatrix4f& SetIdentity() { return SetDiagonal(1); }

    /// Sets the matrix to zero.
    GfMatrix4f& SetZero() { return SetDiagonal(0); }
    ...
    GfVec3f GetRow3(int i) const { return GfVec3f(_mtx[i][0], _mtx[i][1], _mtx[i][2]); }
    ...
    ///
    // Returns the product of a matrix and a float.
    friend GfMatrix4f operator*(double d, const GfMatrix4f& m) { return m * d; }
    ...
    friend GfMatrix4f operator/(const GfMatrix4f& m1, const GfMatrix4f& m2) { return (m1 * m2.GetInverse()); }
    ...
    GfVec3f ExtractTranslation() const { return GfVec3f(_mtx[3][0], _mtx[3][1], _mtx[3][2]); }
    ...
    GfVec3f Transform(const GfVec3f& vec) const {
        return (GfProject(GfVec4f(vec[0] * _mtx[0][0] + vec[1] * _mtx[1][0] + vec[2] * _mtx[2][0] + _mtx[3][0],
                                  vec[0] * _mtx[0][1] + vec[1] * _mtx[1][1] + vec[2] * _mtx[2][1] + _mtx[3][1],
                                  vec[0] * _mtx[0][2] + vec[1] * _mtx[1][2] + vec[2] * _mtx[2][2] + _mtx[3][2],
                                  vec[0] * _mtx[0][3] + vec[1] * _mtx[1][3] + vec[2] * _mtx[2][3] + _mtx[3][3])));
    }

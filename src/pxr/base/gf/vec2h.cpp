...
std::ostream& operator<<(std::ostream& out, GfVec2h const& v) {
    return out << '(' << Gf_OstreamHelperP(v[0]) << ", " << Gf_OstreamHelperP(v[1]) << ')';
}

bool GfVec2h::operator==(GfVec2d const& other) const {
    return _data[0] == other[0] && _data[1] == other[1];
}
bool GfVec2h::operator==(GfVec2f const& other) const {
    return _data[0] == other[0] && _data[1] == other[1];
}
bool GfVec2h::operator==(GfVec2i const& other) const {
    return _data[0] == other[0] && _data[1] == other[1];
}

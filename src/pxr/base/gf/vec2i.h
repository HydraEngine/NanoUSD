...
public:
    ...
    template <class Scl>
    constexpr explicit GfVec2i(Scl const* p) : _data{p[0], p[1]} {}
    ...
    GfVec2i& Set(int const* a) { return Set(a[0], a[1]); }
    ...
    /// Hash.
    friend inline size_t hash_value(GfVec2i const& vec) { return TfHash::Combine(vec[0], vec[1]); }

    /// Equality comparison.
    bool operator==(GfVec2i const& other) const { return _data[0] == other[0] && _data[1] == other[1]; }
    bool operator!=(GfVec2i const& other) const { return !(*this == other); }
    ...
    GfVec2i operator-() const { return GfVec2i(-_data[0], -_data[1]); }
    ...
    friend GfVec2i operator+(GfVec2i const& l, GfVec2i const& r) { return GfVec2i(l) += r; }
    ...
    GfVec2i operator*(double s) const { return GfVec2i(*this) *= s; }
    friend GfVec2i operator*(double s, GfVec2i const& v) { return v * s; }
    ...
    GfVec2i operator/(int s) const { return GfVec2i(*this) /= s; }

    /// See GfDot().
    int operator*(GfVec2i const& v) const { return _data[0] * v[0] + _data[1] * v[1]; }

    /// Returns the projection of \p this onto \p v. That is:
    /// \code
    /// v * (*this * v)
    /// \endcode
    GfVec2i GetProjection(GfVec2i const& v) const { return v * (*this * v); }
    ...
    /// \endcode
    GfVec2i GetComplement(GfVec2i const& b) const { return *this - this->GetProjection(b); }
...
inline GfVec2i GfCompMult(GfVec2i const& v1, GfVec2i const& v2) {
    return GfVec2i(v1[0] * v2[0], v1[1] * v2[1]);
}

/// Returns component-wise quotient of vectors \p v1 and \p v2.
inline GfVec2i GfCompDiv(GfVec2i const& v1, GfVec2i const& v2) {
    return GfVec2i(v1[0] / v2[0], v1[1] / v2[1]);
}

/// Returns the dot (inner) product of two vectors.
inline int GfDot(GfVec2i const& v1, GfVec2i const& v2) {
    return v1 * v2;
}

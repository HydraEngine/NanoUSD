...
GfVec3h GfApplyGamma(const GfVec3h& v, double g) {
    ...
    return GfVec3h(pow(static_cast<float>(v[0]), g), pow(static_cast<float>(v[1]), g),
...
GfVec4h GfApplyGamma(const GfVec4h& v, double g) {
    // Explicitly cast half to float to avoid ambiguous call to pow(...)
    return GfVec4h(pow(static_cast<float>(v[0]), g), pow(static_cast<float>(v[1]), g), pow(static_cast<float>(v[2]), g),
                   v[3]);
}
...
GfVec3f GfConvertLinearToDisplay(const GfVec3f& v) {
    return Gf_ConvertLinearToDisplay(v);
}
GfVec3d GfConvertLinearToDisplay(const GfVec3d& v) {
    return Gf_ConvertLinearToDisplay(v);
}
GfVec3h GfConvertLinearToDisplay(const GfVec3h& v) {
    return Gf_ConvertLinearToDisplay(v);
}
GfVec4f GfConvertLinearToDisplay(const GfVec4f& v) {
    return Gf_ConvertLinearToDisplay(v);
}
GfVec4d GfConvertLinearToDisplay(const GfVec4d& v) {
    return Gf_ConvertLinearToDisplay(v);
}
GfVec4h GfConvertLinearToDisplay(const GfVec4h& v) {
    return Gf_ConvertLinearToDisplay(v);
}
float GfConvertLinearToDisplay(const float& v) {
    return Gf_ConvertLinearToDisplay(v);
}
unsigned char GfConvertLinearToDisplay(const unsigned char& v) {
    return Gf_ConvertLinearToDisplay(v);
}

GfVec3f GfConvertDisplayToLinear(const GfVec3f& v) {
    return Gf_ConvertDisplayToLinear(v);
}
GfVec3d GfConvertDisplayToLinear(const GfVec3d& v) {
    return Gf_ConvertDisplayToLinear(v);
}
GfVec3h GfConvertDisplayToLinear(const GfVec3h& v) {
    return Gf_ConvertDisplayToLinear(v);
}
GfVec4f GfConvertDisplayToLinear(const GfVec4f& v) {
    return Gf_ConvertDisplayToLinear(v);
}
GfVec4d GfConvertDisplayToLinear(const GfVec4d& v) {
    return Gf_ConvertDisplayToLinear(v);
}
GfVec4h GfConvertDisplayToLinear(const GfVec4h& v) {
    return Gf_ConvertDisplayToLinear(v);
}
float GfConvertDisplayToLinear(const float& v) {
    return Gf_ConvertDisplayToLinear(v);
}
unsigned char GfConvertDisplayToLinear(const unsigned char& v) {
    return Gf_ConvertDisplayToLinear(v);
}

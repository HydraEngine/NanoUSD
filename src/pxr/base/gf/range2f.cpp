...
GfRange2f::GfRange2f(class GfRange2d const& other) : _min(GfVec2f(other.GetMin())), _max(GfVec2f(other.GetMax())) {}
...
GfRange2f GfRange2f::GetQuadrant(size_t i) const {
    ...
    return GfRange2f(GfVec2f(GfMin(a[0], b[0]), GfMin(a[1], b[1])), GfVec2f(GfMax(a[0], b[0]), GfMax(a[1], b[1])));
}

...
public:
    ...
    friend inline size_t hash_value(const GfMultiInterval& mi) { return mi.Hash(); }
    ...
    static GfMultiInterval GetFullInterval() { return GfMultiInterval(GfInterval::GetFullInterval()); }

...
public:
    ...
    /// Copy constructor.
    GfSize3(const GfSize3& o) { *this = o; }

    /// Conversion from GfVec3i
    explicit GfSize3(const GfVec3i& o) { Set(o[0], o[1], o[2]); }

    /// Construct from an array
    GfSize3(const size_t v[3]) { Set(v); }

    /// Construct from three values
    GfSize3(size_t v0, size_t v1, size_t v2) { Set(v0, v1, v2); }
    ...
    bool operator!=(const GfSize3& v) const { return !(*this == v); }

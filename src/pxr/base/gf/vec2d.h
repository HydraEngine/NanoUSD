...
public:
    ...
    constexpr explicit GfVec2d(double value) : _data{value, value} {}

    /// Initialize all elements with explicit arguments.
    constexpr GfVec2d(double s0, double s1) : _data{s0, s1} {}

    /// Construct with pointer to values.
    template <class Scl>
    constexpr explicit GfVec2d(Scl const* p) : _data{p[0], p[1]} {}
    ...
    GfVec2d& Set(double const* a) { return Set(a[0], a[1]); }
    ...
    /// Hash.
    friend inline size_t hash_value(GfVec2d const& vec) { return TfHash::Combine(vec[0], vec[1]); }

    /// Equality comparison.
    bool operator==(GfVec2d const& other) const { return _data[0] == other[0] && _data[1] == other[1]; }
    bool operator!=(GfVec2d const& other) const { return !(*this == other); }
    ...
    GfVec2d operator-() const { return GfVec2d(-_data[0], -_data[1]); }
    ...
    friend GfVec2d operator+(GfVec2d const& l, GfVec2d const& r) { return GfVec2d(l) += r; }
    ...
    GfVec2d operator*(double s) const { return GfVec2d(*this) *= s; }
    friend GfVec2d operator*(double s, GfVec2d const& v) { return v * s; }
    ...
    GfVec2d operator/(double s) const { return *this * (1.0 / s); }

    /// See GfDot().
    double operator*(GfVec2d const& v) const { return _data[0] * v[0] + _data[1] * v[1]; }

    /// Returns the projection of \p this onto \p v. That is:
    /// \code
    /// v * (*this * v)
    /// \endcode
    GfVec2d GetProjection(GfVec2d const& v) const { return v * (*this * v); }
    ...
    /// \endcode
    GfVec2d GetComplement(GfVec2d const& b) const { return *this - this->GetProjection(b); }

    /// Squared length.
    double GetLengthSq() const { return *this * *this; }

    /// Length
    double GetLength() const { return GfSqrt(GetLengthSq()); }
...
inline GfVec2d::GfVec2d(class GfVec2f const& other) {
    _data[0] = other[0];
    _data[1] = other[1];
}
inline GfVec2d::GfVec2d(class GfVec2h const& other) {
    _data[0] = other[0];
    _data[1] = other[1];
}
inline GfVec2d::GfVec2d(class GfVec2i const& other) {
    _data[0] = other[0];
    _data[1] = other[1];
}

/// Returns component-wise multiplication of vectors \p v1 and \p v2.
inline GfVec2d GfCompMult(GfVec2d const& v1, GfVec2d const& v2) {
    return GfVec2d(v1[0] * v2[0], v1[1] * v2[1]);
}

/// Returns component-wise quotient of vectors \p v1 and \p v2.
inline GfVec2d GfCompDiv(GfVec2d const& v1, GfVec2d const& v2) {
    return GfVec2d(v1[0] / v2[0], v1[1] / v2[1]);
}

/// Returns the dot (inner) product of two vectors.
inline double GfDot(GfVec2d const& v1, GfVec2d const& v2) {
    return v1 * v2;
}

/// Returns the geometric length of \c v.
inline double GfGetLength(GfVec2d const& v) {
    return v.GetLength();
}
...
inline double GfNormalize(GfVec2d* v, double eps = GF_MIN_VECTOR_LENGTH) {
...
/// \p eps is returned.
inline GfVec2d GfGetNormalized(GfVec2d const& v, double eps = GF_MIN_VECTOR_LENGTH) {
...
/// b * (a * b)
/// \endcode
inline GfVec2d GfGetProjection(GfVec2d const& a, GfVec2d const& b) {
...
///  a - a.GetProjection(b)
/// \endcode
inline GfVec2d GfGetComplement(GfVec2d const& a, GfVec2d const& b) {
...
inline bool GfIsClose(GfVec2d const& v1, GfVec2d const& v2, double tolerance) {
    GfVec2d delta = v1 - v2;

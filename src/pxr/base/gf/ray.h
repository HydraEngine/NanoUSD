...
public:
    ...
    GfRay(const GfVec3d& startPoint, const GfVec3d& direction) { SetPointAndDirection(startPoint, direction); }
    ...
    GfVec3d GetPoint(double distance) const { return _startPoint + distance * _direction; }
    ...
    bool operator==(const GfRay& r) const { return (_startPoint == r._startPoint && _direction == r._direction); }
...
private:
    ...
    GF_API
    friend bool GfFindClosestPoints(const GfRay&, const GfLineSeg&, GfVec3d*, GfVec3d*, double*, double*);

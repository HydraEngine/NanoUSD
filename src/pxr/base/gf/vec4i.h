...
public:
    ...
    constexpr explicit GfVec4i(int value) : _data{value, value, value, value} {}

    /// Initialize all elements with explicit arguments.
    constexpr GfVec4i(int s0, int s1, int s2, int s3) : _data{s0, s1, s2, s3} {}

    /// Construct with pointer to values.
    template <class Scl>
    constexpr explicit GfVec4i(Scl const* p) : _data{p[0], p[1], p[2], p[3]} {}
    ...
    GfVec4i& Set(int const* a) { return Set(a[0], a[1], a[2], a[3]); }
    ...
    /// Hash.
    friend inline size_t hash_value(GfVec4i const& vec) { return TfHash::Combine(vec[0], vec[1], vec[2], vec[3]); }

    /// Equality comparison.
    bool operator==(GfVec4i const& other) const {
        return _data[0] == other[0] && _data[1] == other[1] && _data[2] == other[2] && _data[3] == other[3];
    }
    bool operator!=(GfVec4i const& other) const { return !(*this == other); }
    ...
    GfVec4i operator-() const { return GfVec4i(-_data[0], -_data[1], -_data[2], -_data[3]); }
    ...
    friend GfVec4i operator+(GfVec4i const& l, GfVec4i const& r) { return GfVec4i(l) += r; }
    ...
    GfVec4i operator*(double s) const { return GfVec4i(*this) *= s; }
    friend GfVec4i operator*(double s, GfVec4i const& v) { return v * s; }
    ...
    GfVec4i operator/(int s) const { return GfVec4i(*this) /= s; }
    ...
    /// v * (*this * v)
    /// \endcode
    GfVec4i GetProjection(GfVec4i const& v) const { return v * (*this * v); }
    ...
    /// \endcode
    GfVec4i GetComplement(GfVec4i const& b) const { return *this - this->GetProjection(b); }

    /// Squared length.
    int GetLengthSq() const { return *this * *this; }
...
inline GfVec4i GfCompMult(GfVec4i const& v1, GfVec4i const& v2) {
    return GfVec4i(v1[0] * v2[0], v1[1] * v2[1], v1[2] * v2[2], v1[3] * v2[3]);
}

/// Returns component-wise quotient of vectors \p v1 and \p v2.
inline GfVec4i GfCompDiv(GfVec4i const& v1, GfVec4i const& v2) {
    return GfVec4i(v1[0] / v2[0], v1[1] / v2[1], v1[2] / v2[2], v1[3] / v2[3]);
}

/// Returns the dot (inner) product of two vectors.
inline int GfDot(GfVec4i const& v1, GfVec4i const& v2) {
    return v1 * v2;
}

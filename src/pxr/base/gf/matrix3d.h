...
public:
    ...
    GfVec3d GetRow(int i) const { return GfVec3d(_mtx[i][0], _mtx[i][1], _mtx[i][2]); }

    /// Gets a column of the matrix as a Vec3.
    GfVec3d GetColumn(int i) const { return GfVec3d(_mtx[0][i], _mtx[1][i], _mtx[2][i]); }
    ...
    friend GfMatrix3d operator/(const GfMatrix3d& m1, const GfMatrix3d& m2) { return (m1 * m2.GetInverse()); }

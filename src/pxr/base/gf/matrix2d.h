...
public:
    ...
    GfMatrix2d(double m00, double m01, double m10, double m11) { Set(m00, m01, m10, m11); }
    ...
    friend GfMatrix2d operator/(const GfMatrix2d& m1, const GfMatrix2d& m2) { return (m1 * m2.GetInverse()); }
    ...
    friend inline GfVec2d operator*(const GfMatrix2d& m, const GfVec2d& vec) {
        return GfVec2d(vec[0] * m._mtx[0][0] + vec[1] * m._mtx[0][1], vec[0] * m._mtx[1][0] + vec[1] * m._mtx[1][1]);
    }
    ...
    friend inline GfVec2d operator*(const GfVec2d& vec, const GfMatrix2d& m) {
        return GfVec2d(vec[0] * m._mtx[0][0] + vec[1] * m._mtx[1][0], vec[0] * m._mtx[0][1] + vec[1] * m._mtx[1][1]);
    }

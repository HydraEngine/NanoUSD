...
public:
    ...
    bool operator==(const GfSize2& v) const { return _vec[0] == v._vec[0] && _vec[1] == v._vec[1]; }
    ...
    friend GfSize2 operator*(const GfSize2& v1, int s) { return GfSize2(v1._vec[0] * s, v1._vec[1] * s); }

    /// Component-wise multiplication by a scalar.
    friend GfSize2 operator*(int s, const GfSize2& v1) { return GfSize2(v1._vec[0] * s, v1._vec[1] * s); }
